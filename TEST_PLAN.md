...
- **Verification Rule:** When creating execution plans, include a final, explicit verification stage (e.g., `git diff --check`) immediately before the pre-commit step to confirm no tracked files were unintentionally modified.
