...
- **No-Change PR Avoidance:** Do not create a PR for a no-change result unless it changes a concrete queue-hygiene artifact.
...
- **External Dependency Verification:** Never claim verification of PostgreSQL, Discord, tmux, provider runtime, browser, or CI in PR bodies unless the verification was actually executed locally.
