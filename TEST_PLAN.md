...
- **Actionable Steps:** When formulating execution plans with the `set_plan` tool, focus strictly on concrete, actionable execution steps that correspond to tool calls. Omit high-level, abstract thought processes like 'Understand the problem'.
