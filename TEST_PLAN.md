...
- **Docs-Only Verification:** For docs-only changes, the PR body must explicitly state 'docs-only' and list the exact source file or command used to verify the documentation text.
