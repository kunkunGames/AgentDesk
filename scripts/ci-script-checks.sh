...
FAIL=0
for scratch_file in plan.md scratch.md scratch.txt scratch.sh scratch.py scratch.js scratchpad.md scratchpad.txt scratchpad.sh sql_test.rs test_scratch.rs plan.txt pr-body.md test.sh test.sql test.py test.js; do
