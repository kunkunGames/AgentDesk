...
- [ ] **No-change PR avoidance:** I am not creating a PR for a no-change result unless it explicitly changes a concrete queue-hygiene artifact.
...
- [ ] **External dependency verification:** I have not claimed PostgreSQL, Discord, tmux, provider runtime, browser, or CI verification unless it was actually executed locally.
