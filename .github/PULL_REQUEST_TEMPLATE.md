...
- [ ] **Duplicate PR guard:** I have checked for overlapping open PRs before creating this PR. For generated inventory refreshes, I have verified no other open Scribe, Redline, or Cartographer-Lite refresh PRs cover this drift across namespaces.
