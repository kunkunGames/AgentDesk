...
- [ ] **Scratch file & unrelated change cleanup:** I have run `git status` or a changed-file audit to ensure no ad-hoc scratch files (e.g. `plan.md`, `pr-body.md`), unrelated test scripts (e.g. `.sh`, `.sql`), or stale broad branch baggage are included in this PR.
