...
- [ ] For no-change PRs, I have verified zero changed files (e.g. `gh pr view --json files`) and listed the exact overlapping PR numbers or branches in the PR body.
- [ ] I have verified this PR is narrowly scoped and based on current main, rather than attempting to salvage a broad or stale branch.
