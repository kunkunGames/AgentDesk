...
- [ ] **Duplicate PR guard:** I have checked for overlapping open PRs before creating this PR (especially for generated refresh work). If my generated inventory refresh overlaps with an existing PR, I have stopped and reported a no-change overlap.
