var pipeline = {
  ...
  //
  // Ordering (#1079, #5716): pipeline runs at priority 200. Kanban-rules (P10)
  // fires first on this hook to resolve the dispatch record; pipeline is
  // intentionally a no-op here so the hook sequence is deterministic.
