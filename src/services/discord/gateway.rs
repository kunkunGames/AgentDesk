...
pub(super) use merged_placeholders::drain_merged_queued_placeholders;
...
pub(super) trait TurnGateway: Send + Sync {
    ...
    /// REST delivery does not require a Gateway connection. Runner turns can
    /// edit their own placeholder while queue admission stays with the hub.
