...
mod tests {
    ...
    impl super::super::GitHubAdapter for MockAdapter {
        ...
        ) -> super::super::GitHubFuture<'a, Result<String, String>> {
            Box::pin(async { Err("unexpected async call".to_string()) })
        }
    }
    ...
    fn fetch_issues_routes_through_adapter_interface() {
        let adapter = MockAdapter::new(vec![Ok(
