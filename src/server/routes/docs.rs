                ...
                "connectors": [
                    {
                        ...
                        "setup_actions": [
                            "Set AGENTDESK_OBSIDIAN_SKILL_ROOT to an existing skill directory, or run scripts/operator-init-portable.py --with-obsidian-stubs to create starter directories."
                        ],
