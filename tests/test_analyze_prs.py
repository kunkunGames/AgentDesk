...
class PrAnalyzerVerificationGroundingGuardTests(unittest.TestCase):
    def test_unchecked_template_verification_grounding_guard_is_not_acknowledgement(self):
        body = "- [ ] **Verification grounding:** I have not falsely claimed verification for PostgreSQL, Discord, tmux, provider runtime, browser, or CI unless it was actually executed."
    ...
    def test_checked_template_verification_grounding_guard_is_acknowledgement(self):
        body = "- [X] **Verification grounding:** I have not falsely claimed verification for PostgreSQL, Discord, tmux, provider runtime, browser, or CI unless it was actually executed."

        self.assertTrue(has_verification_grounding_ack(body))

    def test_filled_verification_grounding_field_is_acknowledgement(self):
        body = "- verification grounding: checked."
