...
const optimized_query_lateral_exists = `
      SELECT r.id
      FROM auto_queue_runs r
...
execSync(`sudo -u postgres psql -d agentdesk -c "EXPLAIN ANALYZE ${optimized_query_lateral_exists}" > qopt_lat_exists.out`);

console.log('Q1 output:\n', fs.readFileSync('q1.out', 'utf8'));
console.log('\n\nQOPT LATERAL output:\n', fs.readFileSync('qopt_lat.out', 'utf8'));
console.log('\n\nQOPT LATERAL EXISTS output:\n', fs.readFileSync('qopt_lat_exists.out', 'utf8'));
