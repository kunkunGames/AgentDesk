...
| Variable | Defined at | Description |
|---|---|---|
| `ANTHROPIC_API_KEY` | `src/server/rate_limit_sync.rs:265` (+1 more) | Priority: 1) OAuth token (Claude Code subscription), 2) ANTHROPIC_API_KEY. |
...
| `GEMINI_CLIENT_ID` | `src/server/mod.rs:1525` | env vars GEMINI_CLIENT_ID / GEMINI_CLIENT_SECRET 2. |
