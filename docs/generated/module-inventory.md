...
| `server::routes::dispatches::thread_reuse` | `src/server/routes/dispatches/thread_reuse.rs` | 1250 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 5833 | giant-file |
