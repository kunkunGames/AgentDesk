...
| `services::claude_tui::transcript_tail` | `src/services/claude_tui/transcript_tail.rs` | 401 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 3322 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 11588 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 6471 | giant-file |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 6768 | giant-file |
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 2029 | giant-file |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 8460 | giant-file |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 2202 | giant-file |
...
| `services::routines::runtime` | `src/services/routines/runtime.rs` | 906 |  |
...
| `services::tui_turn_state` | `src/services/tui_turn_state.rs` | 996 |  |
