...
| `services::discord` | `src/services/discord/mod.rs` | 5682 | 4944 | 738 | giant-file |
...
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 3288 | 2802 | 486 | giant-file |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 998 | 930 | 68 |  |
| `services::discord::health` | `src/services/discord/health.rs` | 413 | 413 | 0 |  |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 3759 | 2615 | 1144 | giant-file |
...
| `services::discord::outbound` | `src/services/discord/outbound/mod.rs` | 43 | 43 | 0 |  |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events/mod.rs` | 458 | 458 | 0 |  |
...
| `services::discord::placeholder_live_events::completion_footer` | `src/services/discord/placeholder_live_events/completion_footer.rs` | 363 | 363 | 0 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4777 | 4083 | 694 | giant-file |
...
| `services::discord::runtime_bootstrap::framework_setup` | `src/services/discord/runtime_bootstrap/framework_setup.rs` | 288 | 288 | 0 |  |
...
| `services::discord::single_message_panel` | `src/services/discord/single_message_panel.rs` | 1835 | 725 | 1110 |  |
...
| `services::discord::tmux_output_stream` | `src/services/discord/tmux_output_stream.rs` | 819 | 618 | 201 |  |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 10767 | 8223 | 2544 | giant-file |
...
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 8929 | 5387 | 3542 | giant-file |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 4797 | 3044 | 1753 | giant-file |
...
| `services::discord::voice_barge_in::routing` | `src/services/discord/voice_barge_in/routing.rs` | 484 | 484 | 0 |  |
...
| `services::session_backend` | `src/services/session_backend.rs` | 1359 | 997 | 362 |  |
