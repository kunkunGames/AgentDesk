...
| `cli::dcserver` | `src/cli/dcserver.rs` | 1681 | 1681 | 0 | giant-file |
...
| `config` | `src/config.rs` | 3233 | 2784 | 449 | giant-file |
...
| `db::auto_queue` | `src/db/auto_queue/mod.rs` | 22 | 22 | 0 |  |
...
| `db::auto_queue::phase_gate_verdict` | `src/db/auto_queue/phase_gate_verdict.rs` | 567 | 234 | 333 |  |
| `db::auto_queue::phase_gates` | `src/db/auto_queue/phase_gates.rs` | 3241 | 1519 | 1722 | giant-file |
...
| `db::dispatched_sessions` | `src/db/dispatched_sessions.rs` | 2730 | 1860 | 870 | giant-file |
...
| `db::postgres` | `src/db/postgres.rs` | 2844 | 1414 | 1430 | giant-file |
...
| `dispatch::dispatch_status` | `src/dispatch/dispatch_status.rs` | 1790 | 1399 | 391 | giant-file |
...
| `reconcile` | `src/reconcile.rs` | 2951 | 1908 | 1043 | giant-file |
...
| `server` | `src/server/mod.rs` | 3604 | 2800 | 804 | giant-file |
...
| `server::routes` | `src/server/routes/mod.rs` | 571 | 336 | 235 |  |
...
| `server::routes::dispatched_sessions` | `src/server/routes/dispatched_sessions.rs` | 196 | 196 | 0 |  |
...
| `server::routes::docs::inventory::endpoints::part_06` | `src/server/routes/docs/inventory/endpoints/part_06.rs` | 810 | 810 | 0 |  |
| `server::routes::docs::inventory::endpoints::part_07` | `src/server/routes/docs/inventory/endpoints/part_07.rs` | 679 | 679 | 0 |  |
| `server::routes::docs::inventory::endpoints::part_08` | `src/server/routes/docs/inventory/endpoints/part_08.rs` | 749 | 749 | 0 |  |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 398 | 398 | 0 |  |
...
| `server::routes::health_api` | `src/server/routes/health_api.rs` | 2748 | 1812 | 936 | giant-file |
...
| `server::routes::routines::handlers` | `src/server/routes/routines/handlers.rs` | 510 | 510 | 0 |  |
| `server::routes::routines::helpers` | `src/server/routes/routines/helpers.rs` | 333 | 252 | 81 |  |
...
| `services` | `src/services/mod.rs` | 154 | 154 | 0 |  |
...
| `services::claude_tui::hook_relay::ordered_queue` | `src/services/claude_tui/hook_relay/ordered_queue.rs` | 2017 | 923 | 1094 |  |
...
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 4125 | 2266 | 1859 | giant-file |
...
| `services::cluster::intake_router_hook` | `src/services/cluster/intake_router_hook.rs` | 2817 | 889 | 1928 |  |
...
| `services::cluster::intake_routing_config` | `src/services/cluster/intake_routing_config.rs` | 228 | 181 | 47 |  |
| `services::cluster::intake_routing_telemetry` | `src/services/cluster/intake_routing_telemetry.rs` | 470 | 369 | 101 |  |
| `services::cluster::intake_worker` | `src/services/cluster/intake_worker.rs` | 695 | 512 | 183 |  |
...
| `services::cluster::stream_relay` | `src/services/cluster/stream_relay.rs` | 1726 | 956 | 770 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 5735 | 4159 | 1576 | giant-file |
| `services::discord::abandon_request_store` | `src/services/discord/abandon_request_store.rs` | 862 | 601 | 261 |  |
| `services::discord::adk_session` | `src/services/discord/adk_session.rs` | 1063 | 948 | 115 |  |
...
| `services::discord::catch_up` | `src/services/discord/catch_up.rs` | 3218 | 1809 | 1409 | giant-file |
...
| `services::discord::commands::control` | `src/services/discord/commands/control.rs` | 970 | 903 | 67 |  |
...
| `services::discord::commands::session` | `src/services/discord/commands/session.rs` | 366 | 366 | 0 |  |
...
| `services::discord::completion_footer_metadata` | `src/services/discord/completion_footer_metadata.rs` | 377 | 194 | 183 |  |
...
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 199 | 125 | 74 |  |
| `services::discord::formatting::delivery` | `src/services/discord/formatting/delivery.rs` | 486 | 486 | 0 |  |
| `services::discord::formatting::long_send_rollback` | `src/services/discord/formatting/long_send_rollback.rs` | 482 | 482 | 0 |  |
| `services::discord::formatting::replace_long_message` | `src/services/discord/formatting/replace_long_message.rs` | 552 | 552 | 0 |  |
...
| `services::discord::formatting::tool_markdown` | `src/services/discord/formatting/tool_markdown.rs` | 698 | 698 | 0 |  |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 1473 | 986 | 487 |  |
...
| `services::discord::health` | `src/services/discord/health.rs` | 928 | 757 | 171 |  |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 6017 | 2633 | 3384 | giant-file |
...
| `services::discord::health::relay_auto_heal` | `src/services/discord/health/relay_auto_heal.rs` | 2155 | 724 | 1431 |  |
...
| `services::discord::health::stall_liveness::redrive_grace` | `src/services/discord/health/stall_liveness/redrive_grace.rs` | 1446 | 675 | 771 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 5875 | 632 | 5243 |  |
...
| `services::discord::inflight::save_store` | `src/services/discord/inflight/save_store.rs` | 981 | 247 | 734 |  |
| `services::discord::inflight::save_store::delivery_rewind` | `src/services/discord/inflight/save_store/delivery_rewind.rs` | 59 | 59 | 0 |  |
| `services::discord::inflight::save_store::identity_gate` | `src/services/discord/inflight/save_store/identity_gate.rs` | 1412 | 953 | 459 |  |
...
| `services::discord::inflight::save_store::identity_gate::runtime_stamp` | `src/services/discord/inflight/save_store/identity_gate/runtime_stamp.rs` | 365 | 96 | 269 |  |
| `services::discord::inflight::save_store::identity_gate::stream_loop_patch` | `src/services/discord/inflight/save_store/identity_gate/stream_loop_patch.rs` | 359 | 176 | 183 |  |
...
| `services::discord::inflight::store` | `src/services/discord/inflight/store.rs` | 423 | 369 | 54 |  |
...
| `services::discord::outbound::delivery_record` | `src/services/discord/outbound/delivery_record.rs` | 3730 | 1643 | 2087 | giant-file |
| `services::discord::outbound::manual_delivery` | `src/services/discord/outbound/manual_delivery.rs` | 1294 | 664 | 630 |  |
...
| `services::discord::placeholder_controller` | `src/services/discord/placeholder_controller.rs` | 1268 | 673 | 595 |  |
...
| `services::discord::placeholder_live_events::common` | `src/services/discord/placeholder_live_events/common.rs` | 236 | 236 | 0 |  |
...
| `services::discord::placeholder_sweeper` | `src/services/discord/placeholder_sweeper.rs` | 1299 | 984 | 315 |  |
...
| `services::discord::queue_dispatch` | `src/services/discord/queue_dispatch.rs` | 140 | 140 | 0 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 525 | 469 | 56 |  |
...
| `services::discord::recovery_engine::manual_rebind` | `src/services/discord/recovery_engine/manual_rebind/mod.rs` | 1337 | 911 | 426 |  |
...
| `services::discord::recovery_engine::rebind_runtime` | `src/services/discord/recovery_engine/rebind_runtime.rs` | 2168 | 983 | 1185 |  |
...
| `services::discord::recovery_engine::restore_inflight` | `src/services/discord/recovery_engine/restore_inflight.rs` | 2492 | 2307 | 185 | giant-file |
...
| `services::discord::recovery_engine::runtime` | `src/services/discord/recovery_engine/runtime.rs` | 626 | 325 | 301 |  |
...
| `services::discord::recovery_paths::controller_cutover` | `src/services/discord/recovery_paths/controller_cutover.rs` | 656 | 280 | 376 |  |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 396 | 396 | 0 |  |
| `services::discord::relay_recovery::apply` | `src/services/discord/relay_recovery/apply.rs` | 380 | 380 | 0 |  |
| `services::discord::relay_recovery::decision` | `src/services/discord/relay_recovery/decision.rs` | 413 | 413 | 0 |  |
| `services::discord::relay_recovery::idle_tmux` | `src/services/discord/relay_recovery/idle_tmux.rs` | 375 | 375 | 0 |  |
...
| `services::discord::router` | `src/services/discord/router/mod.rs` | 38 | 38 | 0 |  |
...
| `services::discord::router::intake_dispatch` | `src/services/discord/router/intake_dispatch.rs` | 350 | 350 | 0 |  |
...
| `services::discord::router::intake_dispatch::queued` | `src/services/discord/router/intake_dispatch/queued.rs` | 142 | 142 | 0 |  |
| `services::discord::router::intake_dispatch::skill` | `src/services/discord/router/intake_dispatch/skill.rs` | 52 | 52 | 0 |  |
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 1765 | 1670 | 95 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 321 | 321 | 0 |  |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3045 | 2622 | 423 | giant-file |
...
| `services::discord::router::message_handler::intake_turn::worker_entry` | `src/services/discord/router/message_handler/intake_turn/worker_entry.rs` | 76 | 76 | 0 |  |
...
| `services::discord::router::message_handler::provider_isolation` | `src/services/discord/router/message_handler/provider_isolation.rs` | 874 | 633 | 241 |  |
| `services::discord::router::message_handler::tui_followup` | `src/services/discord/router/message_handler/tui_followup.rs` | 1199 | 980 | 219 |  |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 930 | 318 | 612 |  |
...
| `services::discord::runtime_bootstrap::shared_data` | `src/services/discord/runtime_bootstrap/shared_data.rs` | 264 | 264 | 0 |  |
...
| `services::discord::runtime_store` | `src/services/discord/runtime_store.rs` | 694 | 601 | 93 |  |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 5141 | 1675 | 3466 | giant-file |
...
| `services::discord::session_relay_sink::task_notification_context` | `src/services/discord/session_relay_sink/task_notification_context.rs` | 827 | 525 | 302 |  |
| `services::discord::session_relay_sink::turn_parser` | `src/services/discord/session_relay_sink/turn_parser.rs` | 155 | 155 | 0 |  |
| `services::discord::session_runtime` | `src/services/discord/session_runtime.rs` | 1156 | 549 | 607 |  |
...
| `services::discord::standby_relay` | `src/services/discord/standby_relay.rs` | 1963 | 1012 | 951 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 2703 | 1672 | 1031 | giant-file |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 3547 | 3547 | 0 | giant-file |
...
| `services::discord::tmux_watcher::discrete_trigger_marker` | `src/services/discord/tmux_watcher/discrete_trigger_marker.rs` | 53 | 53 | 0 |  |
...
| `services::discord::tmux_watcher::session_bound_ack` | `src/services/discord/tmux_watcher/session_bound_ack.rs` | 547 | 547 | 0 |  |
...
| `services::discord::tmux_watcher::terminal_direct_fallback` | `src/services/discord/tmux_watcher/terminal_direct_fallback.rs` | 811 | 807 | 4 |  |
| `services::discord::tmux_watcher::terminal_long_chunks` | `src/services/discord/tmux_watcher/terminal_long_chunks.rs` | 340 | 340 | 0 |  |
| `services::discord::tmux_watcher::terminal_readiness` | `src/services/discord/tmux_watcher/terminal_readiness.rs` | 628 | 582 | 46 |  |
| `services::discord::tmux_watcher::terminal_send` | `src/services/discord/tmux_watcher/terminal_send.rs` | 724 | 670 | 54 |  |
| `services::discord::tmux_watcher::turn_identity` | `src/services/discord/tmux_watcher/turn_identity.rs` | 585 | 585 | 0 |  |
...
| `services::discord::tui_direct_pending_start` | `src/services/discord/tui_direct_pending_start.rs` | 4099 | 1607 | 2492 | giant-file |
...
| `services::discord::tui_prompt_relay::claude_idle_runtime` | `src/services/discord/tui_prompt_relay/claude_idle_runtime.rs` | 1067 | 921 | 146 |  |
| `services::discord::tui_prompt_relay::claude_idle_tail` | `src/services/discord/tui_prompt_relay/claude_idle_tail.rs` | 480 | 480 | 0 |  |
| `services::discord::tui_prompt_relay::codex_idle_rollout` | `src/services/discord/tui_prompt_relay/codex_idle_rollout.rs` | 622 | 622 | 0 |  |
...
| `services::discord::tui_prompt_relay::task_notification_prompt` | `src/services/discord/tui_prompt_relay/task_notification_prompt.rs` | 260 | 260 | 0 |  |
...
| `services::discord::turn_bridge::finalize_epilogue` | `src/services/discord/turn_bridge/finalize_epilogue.rs` | 332 | 179 | 153 |  |
| `services::discord::turn_bridge::followup_requeue` | `src/services/discord/turn_bridge/followup_requeue.rs` | 316 | 139 | 177 |  |
| `services::discord::turn_bridge::guards` | `src/services/discord/turn_bridge/guards.rs` | 127 | 127 | 0 |  |
...
| `services::discord::turn_bridge::runtime_handoff_loop::claude_e` | `src/services/discord/turn_bridge/runtime_handoff_loop/claude_e.rs` | 76 | 38 | 38 |  |
| `services::discord::turn_bridge::runtime_handoff_loop::guarded_save` | `src/services/discord/turn_bridge/runtime_handoff_loop/guarded_save.rs` | 283 | 109 | 174 |  |
...
| `services::discord::turn_bridge::stream_loop::content_arms::types` | `src/services/discord/turn_bridge/stream_loop/content_arms/types.rs` | 102 | 102 | 0 |  |
...
| `services::discord::turn_bridge::stream_tick` | `src/services/discord/turn_bridge/stream_tick.rs` | 953 | 829 | 124 |  |
| `services::discord::turn_bridge::stream_tick::guarded_persist` | `src/services/discord/turn_bridge/stream_tick/guarded_persist.rs` | 186 | 51 | 135 |  |
...
| `services::discord::turn_bridge::terminal_controller_cutover` | `src/services/discord/turn_bridge/terminal_controller_cutover.rs` | 1855 | 971 | 884 |  |
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 2013 | 745 | 1268 |  |
...
| `services::discord::turn_bridge::two_message_panel` | `src/services/discord/turn_bridge/two_message_panel.rs` | 1059 | 428 | 631 |  |
...
| `services::discord::turn_finalizer::cleanup` | `src/services/discord/turn_finalizer/cleanup.rs` | 1773 | 688 | 1085 |  |
...
| `services::discord::turn_finalizer::finalize` | `src/services/discord/turn_finalizer/finalize.rs` | 585 | 257 | 328 |  |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 3273 | 994 | 2279 |  |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 90 | 90 | 0 |  |
| `services::discord::watchers::lifecycle::activity` | `src/services/discord/watchers/lifecycle/activity.rs` | 212 | 212 | 0 |  |
| `services::discord::watchers::lifecycle::claims` | `src/services/discord/watchers/lifecycle/claims.rs` | 337 | 337 | 0 |  |
...
| `services::discord::watchers::lifecycle::restore` | `src/services/discord/watchers/lifecycle/restore.rs` | 829 | 829 | 0 |  |
...
| `services::dispatched_sessions` | `src/services/dispatched_sessions.rs` | 2250 | 1798 | 452 | giant-file |
...
| `services::dispatches::wait_queue` | `src/services/dispatches/wait_queue.rs` | 589 | 369 | 220 |  |
...
| `services::platform::tmux` | `src/services/platform/tmux.rs` | 1325 | 992 | 333 |  |
...
| `services::queue` | `src/services/queue.rs` | 968 | 824 | 144 |  |
...
| `services::routines::store` | `src/services/routines/store.rs` | 4315 | 3560 | 755 | giant-file |
...
| `services::session_resume` | `src/services/session_resume.rs` | 819 | 595 | 224 |  |
...
| `services::stale_turn_reconciler` | `src/services/stale_turn_reconciler.rs` | 436 | 201 | 235 |  |
...
| `services::tmux_common` | `src/services/tmux_common.rs` | 2452 | 1385 | 1067 | giant-file |
...
| `services::tui_prompt_dedupe` | `src/services/tui_prompt_dedupe.rs` | 288 | 288 | 0 |  |
...
| `services::tui_prompt_dedupe::runtime_binding` | `src/services/tui_prompt_dedupe/runtime_binding.rs` | 731 | 731 | 0 |  |
| `services::tui_prompt_dedupe::state` | `src/services/tui_prompt_dedupe/state.rs` | 80 | 80 | 0 |  |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 7379 | 3238 | 4141 | giant-file |
| `services::turn_orchestrator::active_source_dedup` | `src/services/turn_orchestrator/active_source_dedup.rs` | 129 | 129 | 0 |  |
| `services::turn_orchestrator::dispatch_cleanup` | `src/services/turn_orchestrator/dispatch_cleanup.rs` | 64 | 64 | 0 |  |
