...
| `config` | `src/config.rs` | 2599 | 2417 | 182 | giant-file |
...
| `engine::ops::db_ops` | `src/engine/ops/db_ops.rs` | 1516 | 1134 | 382 | giant-file |
...
| `server` | `src/server/mod.rs` | 2844 | 2453 | 391 | giant-file |
...
| `server::routes::active_session_audit` | `src/server/routes/active_session_audit.rs` | 734 | 377 | 357 |  |
| `server::routes::agents` | `src/server/routes/agents.rs` | 1106 | 1106 | 0 | giant-file |
...
| `server::routes::health_api` | `src/server/routes/health_api.rs` | 2347 | 2000 | 347 | giant-file |
...
| `services::auto_queue::activate_command` | `src/services/auto_queue/activate_command.rs` | 1486 | 1456 | 30 | giant-file |
...
| `services::claude_tui::hook_registry` | `src/services/claude_tui/hook_registry.rs` | 1152 | 639 | 513 |  |
...
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 2740 | 1629 | 1111 | giant-file |
...
| `services::claude_tui::tui_relay` | `src/services/claude_tui/tui_relay.rs` | 907 | 521 | 386 |  |
...
| `services::codex_tui::rollout_index` | `src/services/codex_tui/rollout_index.rs` | 919 | 481 | 438 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 4757 | 4056 | 701 | giant-file |
...
| `services::discord::catch_up` | `src/services/discord/catch_up.rs` | 810 | 730 | 80 |  |
...
| `services::discord::dispatch_policy` | `src/services/discord/dispatch_policy.rs` | 222 | 181 | 41 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 4736 | 1980 | 2756 | giant-file |
| `services::discord::inflight::budget` | `src/services/discord/inflight/budget.rs` | 338 | 107 | 231 |  |
| `services::discord::inflight::model` | `src/services/discord/inflight/model.rs` | 773 | 590 | 183 |  |
...
| `services::discord::placeholder_sweeper` | `src/services/discord/placeholder_sweeper.rs` | 1255 | 960 | 295 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 3929 | 3276 | 653 | giant-file |
...
| `services::discord::router::message_handler::headless_turn` | `src/services/discord/router/message_handler/headless_turn.rs` | 1462 | 1462 | 0 | giant-file |
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3720 | 3672 | 48 | giant-file |
...
| `services::discord::runtime_bootstrap::framework_setup` | `src/services/discord/runtime_bootstrap/framework_setup.rs` | 318 | 304 | 14 |  |
...
| `services::discord::runtime_bootstrap::recovery_flush` | `src/services/discord/runtime_bootstrap/recovery_flush.rs` | 355 | 355 | 0 |  |
...
| `services::discord::runtime_bootstrap::shared_data` | `src/services/discord/runtime_bootstrap/shared_data.rs` | 184 | 184 | 0 |  |
...
| `services::discord::single_message_panel` | `src/services/discord/single_message_panel.rs` | 2293 | 950 | 1343 |  |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 2722 | 2057 | 665 | giant-file |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 10086 | 6923 | 3163 | giant-file |
...
| `services::discord::tmux_watcher::session_bound_ack` | `src/services/discord/tmux_watcher/session_bound_ack.rs` | 404 | 404 | 0 |  |
...
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 7668 | 4301 | 3367 | giant-file |
...
| `services::discord::tui_prompt_relay::idle_transcript_scan` | `src/services/discord/tui_prompt_relay/idle_transcript_scan.rs` | 278 | 278 | 0 |  |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 6612 | 6189 | 423 | giant-file |
...
| `services::discord::turn_bridge::watcher_handoff` | `src/services/discord/turn_bridge/watcher_handoff.rs` | 605 | 454 | 151 |  |
...
| `services::dispatch_gate` | `src/services/dispatch_gate.rs` | 1184 | 708 | 476 |  |
...
| `services::git::repo_resolver` | `src/services/git/repo_resolver.rs` | 229 | 229 | 0 |  |
...
| `services::opencode` | `src/services/opencode.rs` | 2771 | 2555 | 216 | giant-file |
...
| `services::routines::agent_executor` | `src/services/routines/agent_executor.rs` | 2398 | 1960 | 438 | giant-file |
...
| `services::settings` | `src/services/settings.rs` | 1063 | 1024 | 39 | giant-file |
...
| `services::tui_prompt_dedupe` | `src/services/tui_prompt_dedupe.rs` | 2867 | 1425 | 1442 | giant-file |
