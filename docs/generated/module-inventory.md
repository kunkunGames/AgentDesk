...
<<<<<<< HEAD
- Production Rust modules: `702`
=======
- Production Rust modules: `730`
>>>>>>> origin/main
...
| `server::maintenance` | `src/server/maintenance.rs` | 1025 | 939 | 86 |  |
...
| `server::routes` | `src/server/routes/mod.rs` | 308 | 240 | 68 |  |
...
| `server::routes::health_api` | `src/server/routes/health_api.rs` | 1987 | 1700 | 287 | giant-file |
...
| `services` | `src/services/mod.rs` | 127 | 127 | 0 |  |
...
| `services::agent_quality::regression_alerts` | `src/services/agent_quality/regression_alerts.rs` | 687 | 442 | 245 |  |
...
| `services::auto_queue::fsm` | `src/services/auto_queue/fsm.rs` | 709 | 694 | 15 |  |
...
| `services::claude` | `src/services/claude.rs` | 4004 | 2948 | 1056 | giant-file |
...
| `services::claude_tui` | `src/services/claude_tui/mod.rs` | 13 | 13 | 0 |  |
...
| `services::claude_tui::hook_server` | `src/services/claude_tui/hook_server.rs` | 930 | 492 | 438 |  |
| `services::claude_tui::hosting` | `src/services/claude_tui/hosting/mod.rs` | 13 | 13 | 0 |  |
| `services::claude_tui::hosting::followup_support` | `src/services/claude_tui/hosting/followup_support.rs` | 447 | 401 | 46 |  |
| `services::claude_tui::hosting::warm_followup` | `src/services/claude_tui/hosting/warm_followup.rs` | 676 | 676 | 0 |  |
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 2341 | 1390 | 951 | giant-file |
...
| `services::claude_tui::tui_relay` | `src/services/claude_tui/tui_relay.rs` | 535 | 405 | 130 |  |
...
| `services::codex` | `src/services/codex.rs` | 3660 | 3002 | 658 | giant-file |
| `services::codex_remote_policy` | `src/services/codex_remote_policy.rs` | 49 | 32 | 17 |  |
| `services::codex_tmux_wrapper` | `src/services/codex_tmux_wrapper.rs` | 2298 | 1289 | 1009 | giant-file |
| `services::codex_tui` | `src/services/codex_tui/mod.rs` | 3 | 3 | 0 |  |
| `services::codex_tui::input` | `src/services/codex_tui/input.rs` | 2213 | 1350 | 863 | giant-file |
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 4498 | 1776 | 2722 | giant-file |
| `services::codex_tui::session` | `src/services/codex_tui/session.rs` | 496 | 279 | 217 |  |
<<<<<<< HEAD
| `services::discord` | `src/services/discord/mod.rs` | 5718 | 4980 | 738 | giant-file |
=======
| `services::discord` | `src/services/discord/mod.rs` | 5766 | 4944 | 822 | giant-file |
>>>>>>> origin/main
...
| `services::discord::commands` | `src/services/discord/commands/mod.rs` | 111 | 111 | 0 |  |
| `services::discord::commands::command_policy` | `src/services/discord/commands/command_policy.rs` | 208 | 208 | 0 |  |
| `services::discord::commands::config` | `src/services/discord/commands/config.rs` | 1222 | 954 | 268 |  |
| `services::discord::commands::control` | `src/services/discord/commands/control.rs` | 749 | 749 | 0 |  |
| `services::discord::commands::diagnostics` | `src/services/discord/commands/diagnostics.rs` | 1048 | 1022 | 26 | giant-file |
...
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 3529 | 2802 | 727 | giant-file |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 998 | 930 | 68 |  |
| `services::discord::health` | `src/services/discord/health.rs` | 414 | 414 | 0 |  |
| `services::discord::health::headless_turn` | `src/services/discord/health/headless_turn.rs` | 313 | 313 | 0 |  |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 3778 | 2634 | 1144 | giant-file |
...
| `services::discord::health::snapshot` | `src/services/discord/health/snapshot.rs` | 813 | 813 | 0 |  |
| `services::discord::health::stall_liveness` | `src/services/discord/health/stall_liveness.rs` | 1014 | 546 | 468 |  |
...
| `services::discord::idle_recap` | `src/services/discord/idle_recap.rs` | 2299 | 1299 | 1000 | giant-file |
...
<<<<<<< HEAD
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 5137 | 2523 | 2614 | giant-file |
=======
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 5325 | 2523 | 2802 | giant-file |
>>>>>>> origin/main
...
| `services::discord::outbound` | `src/services/discord/outbound/mod.rs` | 44 | 44 | 0 |  |
...
| `services::discord::outbound::turn_output_controller` | `src/services/discord/outbound/turn_output_controller.rs` | 1692 | 581 | 1111 |  |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events/mod.rs` | 499 | 499 | 0 |  |
| `services::discord::placeholder_live_events::background_task_events` | `src/services/discord/placeholder_live_events/background_task_events.rs` | 108 | 108 | 0 |  |
| `services::discord::placeholder_live_events::common` | `src/services/discord/placeholder_live_events/common.rs` | 196 | 196 | 0 |  |
...
| `services::discord::placeholder_live_events::status_panel` | `src/services/discord/placeholder_live_events/status_panel.rs` | 697 | 697 | 0 |  |
...
| `services::discord::placeholder_live_events::task_panel` | `src/services/discord/placeholder_live_events/task_panel.rs` | 310 | 310 | 0 |  |
...
| `services::discord::placeholder_sweeper` | `src/services/discord/placeholder_sweeper.rs` | 1386 | 988 | 398 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4808 | 4083 | 725 | giant-file |
| `services::discord::recovery_engine::status_panel` | `src/services/discord/recovery_engine/status_panel.rs` | 71 | 55 | 16 |  |
| `services::discord::recovery_paths` | `src/services/discord/recovery_paths/mod.rs` | 30 | 30 | 0 |  |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 1440 | 839 | 601 |  |
...
| `services::discord::role_map` | `src/services/discord/role_map.rs` | 916 | 667 | 249 |  |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 72 | 72 | 0 |  |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 4102 | 3807 | 295 | giant-file |
...
<<<<<<< HEAD
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 916 | 527 | 389 |  |
| `services::discord::runtime_bootstrap::framework_setup` | `src/services/discord/runtime_bootstrap/framework_setup.rs` | 287 | 287 | 0 |  |
| `services::discord::runtime_bootstrap::gateway_lease` | `src/services/discord/runtime_bootstrap/gateway_lease.rs` | 187 | 187 | 0 |  |
=======
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 856 | 274 | 582 |  |
| `services::discord::runtime_bootstrap::framework_setup` | `src/services/discord/runtime_bootstrap/framework_setup.rs` | 302 | 302 | 0 |  |
...
| `services::discord::runtime_bootstrap::recovery_flush` | `src/services/discord/runtime_bootstrap/recovery_flush.rs` | 357 | 357 | 0 |  |
...
| `services::discord::runtime_bootstrap::shared_data` | `src/services/discord/runtime_bootstrap/shared_data.rs` | 183 | 183 | 0 |  |
| `services::discord::runtime_bootstrap::shutdown` | `src/services/discord/runtime_bootstrap/shutdown.rs` | 207 | 207 | 0 |  |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 3680 | 1731 | 1949 | giant-file |
...
<<<<<<< HEAD
| `services::discord::shared_state` | `src/services/discord/shared_state.rs` | 488 | 488 | 0 |  |
=======
| `services::discord::shared_state` | `src/services/discord/shared_state.rs` | 697 | 626 | 71 |  |
| `services::discord::single_message_panel` | `src/services/discord/single_message_panel.rs` | 2186 | 914 | 1272 |  |
>>>>>>> origin/main
| `services::discord::stall_recovery` | `src/services/discord/stall_recovery.rs` | 113 | 113 | 0 |  |
| `services::discord::standby_relay` | `src/services/discord/standby_relay.rs` | 1177 | 746 | 431 |  |
...
<<<<<<< HEAD
| `services::discord::status_panel_orphan_store` | `src/services/discord/status_panel_orphan_store.rs` | 549 | 373 | 176 |  |
=======
...
<<<<<<< HEAD
| `services::discord::tmux_restart_handoff` | `src/services/discord/tmux_restart_handoff.rs` | 521 | 468 | 53 |  |
| `services::discord::tmux_session_files` | `src/services/discord/tmux_session_files.rs` | 501 | 501 | 0 |  |
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 10721 | 8221 | 2500 | giant-file |
| `services::discord::tmux_watcher::commit_decisions` | `src/services/discord/tmux_watcher/commit_decisions.rs` | 293 | 171 | 122 |  |
| `services::discord::tmux_watcher::completion_gate` | `src/services/discord/tmux_watcher/completion_gate.rs` | 275 | 275 | 0 |  |
| `services::discord::tmux_watcher::liveness` | `src/services/discord/tmux_watcher/liveness.rs` | 301 | 301 | 0 |  |
| `services::discord::tmux_watcher::panel_decisions` | `src/services/discord/tmux_watcher/panel_decisions.rs` | 396 | 396 | 0 |  |
=======
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 10810 | 8223 | 2587 | giant-file |
| `services::discord::tmux_watcher::commit_decisions` | `src/services/discord/tmux_watcher/commit_decisions.rs` | 293 | 171 | 122 |  |
| `services::discord::tmux_watcher::completion_gate` | `src/services/discord/tmux_watcher/completion_gate.rs` | 275 | 275 | 0 |  |
| `services::discord::tmux_watcher::liveness` | `src/services/discord/tmux_watcher/liveness.rs` | 310 | 310 | 0 |  |
| `services::discord::tmux_watcher::panel_decisions` | `src/services/discord/tmux_watcher/panel_decisions.rs` | 411 | 411 | 0 |  |
>>>>>>> origin/main
...
| `services::discord::tui_direct_pending_start` | `src/services/discord/tui_direct_pending_start.rs` | 2189 | 952 | 1237 |  |
<<<<<<< HEAD
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 8839 | 5429 | 3410 | giant-file |
| `services::discord::tui_task_card` | `src/services/discord/tui_task_card.rs` | 1206 | 739 | 467 |  |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 7824 | 6778 | 1046 | giant-file |
| `services::discord::turn_bridge::completion_guard` | `src/services/discord/turn_bridge/completion_guard.rs` | 1900 | 1834 | 66 | giant-file |
| `services::discord::turn_bridge::context_window` | `src/services/discord/turn_bridge/context_window.rs` | 119 | 98 | 21 |  |
| `services::discord::turn_bridge::headless_delivery` | `src/services/discord/turn_bridge/headless_delivery.rs` | 469 | 415 | 54 |  |
=======
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 9046 | 5429 | 3617 | giant-file |
| `services::discord::tui_task_card` | `src/services/discord/tui_task_card.rs` | 1287 | 771 | 516 |  |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 7823 | 6777 | 1046 | giant-file |
| `services::discord::turn_bridge::completion_guard` | `src/services/discord/turn_bridge/completion_guard.rs` | 1900 | 1834 | 66 | giant-file |
| `services::discord::turn_bridge::context_window` | `src/services/discord/turn_bridge/context_window.rs` | 119 | 98 | 21 |  |
...
| `services::discord::turn_bridge::recovery_text` | `src/services/discord/turn_bridge/recovery_text.rs` | 643 | 572 | 71 |  |
| `services::discord::turn_bridge::retry_state` | `src/services/discord/turn_bridge/retry_state.rs` | 191 | 191 | 0 |  |
| `services::discord::turn_bridge::single_message_footer` | `src/services/discord/turn_bridge/single_message_footer.rs` | 467 | 378 | 89 |  |
...
<<<<<<< HEAD
| `services::discord::turn_bridge::status_panel` | `src/services/discord/turn_bridge/status_panel.rs` | 437 | 437 | 0 |  |
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 1441 | 604 | 837 |  |
=======
| `services::discord::turn_bridge::status_panel` | `src/services/discord/turn_bridge/status_panel.rs` | 441 | 441 | 0 |  |
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 1603 | 604 | 999 |  |
>>>>>>> origin/main
...
| `services::discord::turn_bridge::watcher_handoff` | `src/services/discord/turn_bridge/watcher_handoff.rs` | 540 | 407 | 133 |  |
| `services::discord::turn_finalizer` | `src/services/discord/turn_finalizer.rs` | 5567 | 1528 | 4039 | giant-file |
<<<<<<< HEAD
| `services::discord::turn_finalizer::cleanup` | `src/services/discord/turn_finalizer/cleanup.rs` | 899 | 350 | 549 |  |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 6393 | 4657 | 1736 | giant-file |
=======
| `services::discord::turn_finalizer::cleanup` | `src/services/discord/turn_finalizer/cleanup.rs` | 904 | 350 | 554 |  |
| `services::discord::voice_acknowledgement` | `src/services/discord/voice_acknowledgement.rs` | 61 | 61 | 0 |  |
| `services::discord::voice_background_driver` | `src/services/discord/voice_background_driver.rs` | 235 | 200 | 35 |  |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 3055 | 2332 | 723 | giant-file |
...
| `services::observability` | `src/services/observability/mod.rs` | 540 | 489 | 51 |  |
| `services::observability::emit` | `src/services/observability/emit.rs` | 745 | 554 | 191 |  |
...
| `services::platform::shell` | `src/services/platform/shell.rs` | 48 | 48 | 0 |  |
...
| `services::review_decision::worktree_stale` | `src/services/review_decision/worktree_stale.rs` | 712 | 553 | 159 |  |
...
=======
| `services::routines::agent_executor` | `src/services/routines/agent_executor.rs` | 2373 | 1935 | 438 | giant-file |
>>>>>>> origin/main
...
| `services::tui_prompt_dedupe` | `src/services/tui_prompt_dedupe.rs` | 2682 | 1356 | 1326 | giant-file |
