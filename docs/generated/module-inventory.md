...
| `server::worker_registry` | `src/server/worker_registry.rs` | 1101 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 6470 | giant-file |
