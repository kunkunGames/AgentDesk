...
| `db::automation_candidates` | `src/db/automation_candidates.rs` | 409 |  |
...
| `server::routes::automation_candidates` | `src/server/routes/automation_candidates.rs` | 217 |  |
...
| `server::routes::domains::kanban` | `src/server/routes/domains/kanban.rs` | 79 |  |
...
| `services` | `src/services/mod.rs` | 70 |  |
...
| `services::automation_candidate_materializer` | `src/services/automation_candidate_materializer.rs` | 388 |  |
...
| `services::routines::store` | `src/services/routines/store.rs` | 2842 | giant-file |
