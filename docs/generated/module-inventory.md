...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 306 |  |
...
| `server::routes::idle_recap` | `src/server/routes/idle_recap.rs` | 123 |  |
...
| `services::claude` | `src/services/claude.rs` | 2669 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 5118 | giant-file |
...
| `services::discord::idle_recap` | `src/services/discord/idle_recap.rs` | 457 |  |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 2563 | giant-file |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7894 | giant-file |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 3111 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 4628 | giant-file |
...
| `services::dispatched_sessions` | `src/services/dispatched_sessions.rs` | 3232 | giant-file |
...
| `services::onboarding` | `src/services/onboarding/mod.rs` | 4943 | giant-file |
...
| `services::provider` | `src/services/provider.rs` | 2222 | giant-file |
