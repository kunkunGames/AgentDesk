...
| `db::postgres` | `src/db/postgres.rs` | 1917 | giant-file |
...
| `server` | `src/server/mod.rs` | 4059 | giant-file |
...
| `services::claude` | `src/services/claude.rs` | 4038 | giant-file |
...
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 1249 | giant-file |
...
| `services::cluster::session_discovery` | `src/services/cluster/session_discovery.rs` | 1208 | giant-file |
...
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 3384 | giant-file |
...
| `services::discord::agentdesk_config` | `src/services/discord/agentdesk_config.rs` | 1375 | giant-file |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 2845 | giant-file |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 10668 | giant-file |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 3289 | giant-file |
...
| `services::discord::settings` | `src/services/discord/settings.rs` | 2465 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 6335 | giant-file |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 4808 | giant-file |
...
| `services::discord_config_audit` | `src/services/discord_config_audit.rs` | 1598 | giant-file |
