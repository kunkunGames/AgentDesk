...
| `server::routes::docs` | `src/server/routes/docs.rs` | 5741 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 296 |  |
...
| `services::opencode` | `src/services/opencode.rs` | 2203 | giant-file |
