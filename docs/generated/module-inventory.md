...
| `server::routes::docs` | `src/server/routes/docs.rs` | 6766 | 6279 | 487 | giant-file |
...
| `server::routes::domains::admin` | `src/server/routes/domains/admin.rs` | 101 | 101 | 0 |  |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 330 | 330 | 0 |  |
...
| `server::routes::tests::preflight_harness::types` | `src/server/routes/tests/preflight_harness/types.rs` | 174 | 174 | 0 |  |
| `server::routes::tests::preflight_harness::validation` | `src/server/routes/tests/preflight_harness/validation.rs` | 249 | 249 | 0 |  |
...
| `services::auto_queue::phase_gate` | `src/services/auto_queue/phase_gate.rs` | 609 | 582 | 27 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 5067 | 4111 | 956 | giant-file |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 3946 | 2731 | 1215 | giant-file |
...
| `services::discord::idle_recap` | `src/services/discord/idle_recap.rs` | 1991 | 991 | 1000 |  |
...
| `services::discord::outbound` | `src/services/discord/outbound/mod.rs` | 51 | 51 | 0 |  |
...
| `services::discord::outbound::delivery_record` | `src/services/discord/outbound/delivery_record.rs` | 2084 | 999 | 1085 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4176 | 3424 | 752 | giant-file |
...
| `services::discord::recovery_paths::restart` | `src/services/discord/recovery_paths/restart.rs` | 1009 | 607 | 402 |  |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 3364 | 2860 | 504 | giant-file |
...
| `services::discord::session_runtime` | `src/services/discord/session_runtime.rs` | 2183 | 1657 | 526 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 2767 | 2039 | 728 | giant-file |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 3041 | 2318 | 723 | giant-file |
...
| `services::dispatches` | `src/services/dispatches/mod.rs` | 168 | 168 | 0 |  |
