...
| `server::routes::review_verdict::decision_route` | `src/server/routes/review_verdict/decision_route.rs` | 139 | 139 | 0 |  |
| `server::routes::review_verdict::decision_route::accept` | `src/server/routes/review_verdict/decision_route/accept.rs` | 703 | 703 | 0 |  |
| `server::routes::review_verdict::decision_route::adapters` | `src/server/routes/review_verdict/decision_route/adapters.rs` | 227 | 227 | 0 |  |
| `server::routes::review_verdict::decision_route::dismiss_finalize` | `src/server/routes/review_verdict/decision_route/dismiss_finalize.rs` | 182 | 182 | 0 |  |
| `server::routes::review_verdict::decision_route::dispute` | `src/server/routes/review_verdict/decision_route/dispute.rs` | 746 | 746 | 0 |  |
| `server::routes::review_verdict::decision_route::pending` | `src/server/routes/review_verdict/decision_route/pending.rs` | 636 | 636 | 0 |  |
| `server::routes::review_verdict::decision_route::repo_card` | `src/server/routes/review_verdict/decision_route/repo_card.rs` | 857 | 748 | 109 |  |
| `server::routes::review_verdict::decision_route::repo_dispatch` | `src/server/routes/review_verdict/decision_route/repo_dispatch.rs` | 650 | 650 | 0 |  |
| `server::routes::review_verdict::decision_route::worktree_stale` | `src/server/routes/review_verdict/decision_route/worktree_stale.rs` | 712 | 553 | 159 |  |
...
| `services::agent_protocol` | `src/services/agent_protocol.rs` | 579 | 579 | 0 |  |
...
| `services::claude` | `src/services/claude.rs` | 5087 | 3991 | 1096 | giant-file |
...
| `services::claude_tui` | `src/services/claude_tui/mod.rs` | 11 | 11 | 0 |  |
...
| `services::cluster::stream_relay` | `src/services/cluster/stream_relay.rs` | 1498 | 959 | 539 |  |
| `services::cluster::watcher_supervisor` | `src/services/cluster/watcher_supervisor.rs` | 845 | 373 | 472 |  |
| `services::codex` | `src/services/codex.rs` | 3659 | 3001 | 658 | giant-file |
...
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 4012 | 1663 | 2349 | giant-file |
| `services::codex_tui::session` | `src/services/codex_tui/session.rs` | 496 | 279 | 217 |  |
| `services::discord` | `src/services/discord/mod.rs` | 5725 | 4987 | 738 | giant-file |
...
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 997 | 929 | 68 |  |
| `services::discord::health` | `src/services/discord/health.rs` | 415 | 415 | 0 |  |
| `services::discord::health::headless_turn` | `src/services/discord/health/headless_turn.rs` | 297 | 297 | 0 |  |
| `services::discord::health::mailbox` | `src/services/discord/health/mailbox.rs` | 111 | 111 | 0 |  |
| `services::discord::health::manual_delivery` | `src/services/discord/health/manual_delivery.rs` | 1177 | 580 | 597 |  |
| `services::discord::health::provider_probe` | `src/services/discord/health/provider_probe.rs` | 242 | 189 | 53 |  |
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 3716 | 2641 | 1075 | giant-file |
| `services::discord::health::redaction` | `src/services/discord/health/redaction.rs` | 33 | 23 | 10 |  |
| `services::discord::health::runtime_resolve` | `src/services/discord/health/runtime_resolve.rs` | 389 | 321 | 68 |  |
| `services::discord::health::send_api` | `src/services/discord/health/send_api.rs` | 445 | 259 | 186 |  |
| `services::discord::health::send_gate` | `src/services/discord/health/send_gate.rs` | 483 | 374 | 109 |  |
| `services::discord::health::send_target` | `src/services/discord/health/send_target.rs` | 199 | 150 | 49 |  |
| `services::discord::health::session_enrichment` | `src/services/discord/health/session_enrichment.rs` | 226 | 226 | 0 |  |
| `services::discord::health::snapshot` | `src/services/discord/health/snapshot.rs` | 798 | 798 | 0 |  |
| `services::discord::http` | `src/services/discord/http.rs` | 178 | 138 | 40 |  |
| `services::discord::idle_detector` | `src/services/discord/idle_detector.rs` | 474 | 400 | 74 |  |
| `services::discord::idle_recap` | `src/services/discord/idle_recap.rs` | 2298 | 1298 | 1000 | giant-file |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 4968 | 2465 | 2503 | giant-file |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events/mod.rs` | 413 | 413 | 0 |  |
...
| `services::discord::placeholder_live_events::subagent_rollout` | `src/services/discord/placeholder_live_events/subagent_rollout.rs` | 287 | 184 | 103 |  |
...
| `services::discord::placeholder_sweeper` | `src/services/discord/placeholder_sweeper.rs` | 1347 | 988 | 359 |  |
...
| `services::discord::queue_io` | `src/services/discord/queue_io.rs` | 382 | 224 | 158 |  |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4705 | 4090 | 615 | giant-file |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 1054 | 736 | 318 |  |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 913 | 524 | 389 |  |
...
| `services::discord::runtime_bootstrap::recovery_flush` | `src/services/discord/runtime_bootstrap/recovery_flush.rs` | 356 | 356 | 0 |  |
...
| `services::discord::runtime_bootstrap::shutdown` | `src/services/discord/runtime_bootstrap/shutdown.rs` | 203 | 203 | 0 |  |
| `services::discord::runtime_bootstrap::spawns` | `src/services/discord/runtime_bootstrap/spawns.rs` | 218 | 218 | 0 |  |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 3655 | 1731 | 1924 | giant-file |
...
| `services::discord::shared_state` | `src/services/discord/shared_state.rs` | 279 | 279 | 0 |  |
| `services::discord::stall_recovery` | `src/services/discord/stall_recovery.rs` | 113 | 113 | 0 |  |
| `services::discord::standby_relay` | `src/services/discord/standby_relay.rs` | 1140 | 733 | 407 |  |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 2399 | 2012 | 387 | giant-file |
...
| `services::discord::tmux_output_stream` | `src/services/discord/tmux_output_stream.rs` | 815 | 614 | 201 |  |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 10569 | 8122 | 2447 | giant-file |
| `services::discord::tmux_watcher::commit_decisions` | `src/services/discord/tmux_watcher/commit_decisions.rs` | 233 | 140 | 93 |  |
...
| `services::discord::tmux_watcher::panel_decisions` | `src/services/discord/tmux_watcher/panel_decisions.rs` | 372 | 372 | 0 |  |
...
| `services::discord::tui_direct_abort_marker` | `src/services/discord/tui_direct_abort_marker/mod.rs` | 2246 | 763 | 1483 |  |
| `services::discord::tui_direct_abort_marker::deferred_claim` | `src/services/discord/tui_direct_abort_marker/deferred_claim.rs` | 350 | 161 | 189 |  |
| `services::discord::tui_direct_abort_marker::store` | `src/services/discord/tui_direct_abort_marker/store.rs` | 348 | 348 | 0 |  |
| `services::discord::tui_direct_pending_start` | `src/services/discord/tui_direct_pending_start.rs` | 2046 | 911 | 1135 |  |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 11035 | 8366 | 2669 | giant-file |
...
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 1344 | 507 | 837 |  |
...
| `services::discord::turn_finalizer` | `src/services/discord/turn_finalizer.rs` | 5566 | 1527 | 4039 | giant-file |
| `services::discord::turn_finalizer::cleanup` | `src/services/discord/turn_finalizer/cleanup.rs` | 475 | 230 | 245 |  |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 6391 | 4657 | 1734 | giant-file |
