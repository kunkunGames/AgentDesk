...
| `db::dispatched_sessions` | `src/db/dispatched_sessions.rs` | 2118 | 1621 | 497 | giant-file |
...
| `services::cluster::intake_router_hook` | `src/services/cluster/intake_router_hook.rs` | 1128 | 491 | 637 |  |
...
| `services::codex` | `src/services/codex.rs` | 3732 | 3023 | 709 | giant-file |
...
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 4756 | 1831 | 2925 | giant-file |
...
| `services::discord::commands::node` | `src/services/discord/commands/node.rs` | 443 | 443 | 0 |  |
...
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 1222 | 992 | 230 |  |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 3947 | 2732 | 1215 | giant-file |
...
| `services::discord::health::relay_dead_reattach` | `src/services/discord/health/relay_dead_reattach.rs` | 226 | 91 | 135 |  |
...
| `services::discord::health::snapshot` | `src/services/discord/health/snapshot.rs` | 983 | 872 | 111 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 7499 | 3180 | 4319 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4148 | 3433 | 715 | giant-file |
...
| `services::discord::runtime_bootstrap::intake` | `src/services/discord/runtime_bootstrap/intake.rs` | 75 | 75 | 0 |  |
...
| `services::discord::settings::read` | `src/services/discord/settings/read.rs` | 483 | 483 | 0 |  |
...
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 8349 | 4574 | 3775 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 6661 | 6238 | 423 | giant-file |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 4578 | 2823 | 1755 | giant-file |
...
| `services::dispatched_sessions` | `src/services/dispatched_sessions.rs` | 1574 | 1441 | 133 | giant-file |
