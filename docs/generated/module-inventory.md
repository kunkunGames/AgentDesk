...
| `db::dispatches::outbox` | `src/db/dispatches/outbox/mod.rs` | 41 |  |
| `db::dispatches::outbox::claim` | `src/db/dispatches/outbox/claim.rs` | 159 |  |
...
| `db::dispatches::outbox::model` | `src/db/dispatches/outbox/model.rs` | 27 |  |
...
| `db::prompt_manifests::storage_stats` | `src/db/prompt_manifests/storage_stats.rs` | 114 |  |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 4974 | giant-file |
...
| `server::routes::prompt_manifest_retention` | `src/server/routes/prompt_manifest_retention.rs` | 55 |  |
...
| `services::discord::commands::inspect::render_prompt` | `src/services/discord/commands/inspect/render_prompt.rs` | 110 |  |
...
| `services::discord::health` | `src/services/discord/health.rs` | 7194 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7038 | giant-file |
...
| `services::dispatches` | `src/services/dispatches/mod.rs` | 462 |  |
...
| `services::dispatches::outbox_route` | `src/services/dispatches/outbox_route.rs` | 1074 | giant-file |
