...
| `cli::args` | `src/cli/args.rs` | 1350 | giant-file |
| `cli::client` | `src/cli/client.rs` | 3174 | giant-file |
| `cli::dcserver` | `src/cli/dcserver.rs` | 1631 | giant-file |
| `cli::direct` | `src/cli/direct.rs` | 1842 | giant-file |
| `cli::discord` | `src/cli/discord.rs` | 123 |  |
| `cli::doctor` | `src/cli/doctor.rs` | 9 |  |
| `cli::doctor::contract` | `src/cli/doctor/contract.rs` | 100 |  |
| `cli::doctor::health` | `src/cli/doctor/health.rs` | 268 |  |
| `cli::doctor::mailbox` | `src/cli/doctor/mailbox.rs` | 256 |  |
| `cli::doctor::orchestrator` | `src/cli/doctor/orchestrator.rs` | 5520 | giant-file |
| `cli::doctor::startup` | `src/cli/doctor/startup.rs` | 624 |  |
| `cli::init` | `src/cli/init.rs` | 1852 | giant-file |
...
| `config` | `src/config.rs` | 3405 | giant-file |
| `crate` | `src/main.rs` | 7 |  |
| `credential` | `src/credential.rs` | 212 |  |
| `db` | `src/db/mod.rs` | 345 |  |
| `db::agents` | `src/db/agents.rs` | 1166 | giant-file |
| `db::auto_queue` | `src/db/auto_queue/mod.rs` | 20 |  |
| `db::auto_queue::claim` | `src/db/auto_queue/claim.rs` | 740 |  |
...
| `db::auto_queue::phase_gates` | `src/db/auto_queue/phase_gates.rs` | 3117 | giant-file |
| `db::auto_queue::queries` | `src/db/auto_queue/queries.rs` | 533 |  |
| `db::auto_queue::runs` | `src/db/auto_queue/runs.rs` | 291 |  |
| `db::auto_queue::slots` | `src/db/auto_queue/slots.rs` | 211 |  |
...
| `db::cancel_tombstones` | `src/db/cancel_tombstones.rs` | 456 |  |
| `db::dispatch_semaphores` | `src/db/dispatch_semaphores.rs` | 331 |  |
| `db::dispatched_sessions` | `src/db/dispatched_sessions.rs` | 2045 | giant-file |
...
| `db::postgres` | `src/db/postgres.rs` | 2078 | giant-file |
...
| `db::schema` | `src/db/schema.rs` | 3263 | giant-file |
...
| `dispatch` | `src/dispatch/mod.rs` | 71 |  |
...
| `dispatch::dispatch_status` | `src/dispatch/dispatch_status.rs` | 2272 | giant-file |
...
| `engine` | `src/engine/mod.rs` | 2721 | giant-file |
| `engine::hooks` | `src/engine/hooks.rs` | 84 |  |
| `engine::intent` | `src/engine/intent.rs` | 873 |  |
| `engine::loader` | `src/engine/loader.rs` | 2006 | giant-file |
...
| `engine::ops::kv_ops` | `src/engine/ops/kv_ops.rs` | 300 |  |
...
| `engine::transition` | `src/engine/transition.rs` | 1363 | giant-file |
...
| `github::sync` | `src/github/sync.rs` | 2202 | giant-file |
| `github::triage` | `src/github/triage.rs` | 878 |  |
...
| `kanban::transition_core` | `src/kanban/transition_core.rs` | 1632 | giant-file |
| `launch` | `src/launch.rs` | 58 |  |
| `lib` | `src/lib.rs` | 173 |  |
| `logging` | `src/logging.rs` | 475 |  |
| `manual_intervention` | `src/manual_intervention.rs` | 65 |  |
| `pipeline` | `src/pipeline.rs` | 2175 | giant-file |
| `receipt` | `src/receipt.rs` | 2147 | giant-file |
| `reconcile` | `src/reconcile.rs` | 1865 | giant-file |
| `runtime` | `src/runtime.rs` | 119 |  |
| `runtime_layout` | `src/runtime_layout/mod.rs` | 1687 | giant-file |
...
| `server` | `src/server/mod.rs` | 4030 | giant-file |
...
| `server::dto::dispatches` | `src/server/dto/dispatches.rs` | 376 |  |
...
| `server::routes::agents` | `src/server/routes/agents.rs` | 1249 | giant-file |
| `server::routes::agents_crud` | `src/server/routes/agents_crud.rs` | 1903 | giant-file |
...
| `server::routes::discord` | `src/server/routes/discord.rs` | 410 |  |
| `server::routes::dispatched_sessions` | `src/server/routes/dispatched_sessions.rs` | 139 |  |
| `server::routes::dispatches` | `src/server/routes/dispatches/mod.rs` | 29 |  |
| `server::routes::dispatches::crud` | `src/server/routes/dispatches/crud.rs` | 1069 | giant-file |
...
| `server::routes::dispatches::thread_reuse` | `src/server/routes/dispatches/thread_reuse.rs` | 1402 | giant-file |
| `server::routes::dm_reply` | `src/server/routes/dm_reply.rs` | 60 |  |
| `server::routes::docs` | `src/server/routes/docs.rs` | 6317 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 334 |  |
...
| `server::routes::routines` | `src/server/routes/routines.rs` | 932 |  |
| `server::routes::session_activity` | `src/server/routes/session_activity.rs` | 442 |  |
| `server::routes::settings` | `src/server/routes/settings.rs` | 97 |  |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 1167 | giant-file |
| `server::ws` | `src/server/ws.rs` | 277 |  |
| `services` | `src/services/mod.rs` | 82 |  |
| `services::agent_protocol` | `src/services/agent_protocol.rs` | 566 |  |
| `services::agent_quality` | `src/services/agent_quality/mod.rs` | 24 |  |
| `services::agent_quality::regression_alerts` | `src/services/agent_quality/regression_alerts.rs` | 687 |  |
| `services::agents` | `src/services/agents/mod.rs` | 2 |  |
| `services::agents::query` | `src/services/agents/query.rs` | 583 |  |
...
| `services::auto_queue::activate_command` | `src/services/auto_queue/activate_command.rs` | 1254 | giant-file |
...
| `services::auto_queue::control_routes` | `src/services/auto_queue/control_routes.rs` | 827 |  |
...
| `services::auto_queue::fsm` | `src/services/auto_queue/fsm.rs` | 914 |  |
...
| `services::auto_queue::runtime` | `src/services/auto_queue/runtime.rs` | 395 |  |
...
| `services::claude` | `src/services/claude.rs` | 5313 | giant-file |
| `services::claude_e` | `src/services/claude_e/mod.rs` | 21 |  |
| `services::claude_e::cancellation` | `src/services/claude_e/cancellation.rs` | 3 |  |
| `services::claude_e::jsonl_parser` | `src/services/claude_e/jsonl_parser.rs` | 4 |  |
| `services::claude_e::process` | `src/services/claude_e/process.rs` | 361 |  |
| `services::claude_e::spawn_queue` | `src/services/claude_e/spawn_queue.rs` | 3 |  |
...
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 1773 | giant-file |
| `services::claude_tui::session` | `src/services/claude_tui/session.rs` | 337 |  |
| `services::claude_tui::transcript_tail` | `src/services/claude_tui/transcript_tail.rs` | 561 |  |
...
| `services::cluster::session_matcher` | `src/services/cluster/session_matcher.rs` | 943 |  |
...
| `services::codex` | `src/services/codex.rs` | 3909 | giant-file |
| `services::codex_remote_policy` | `src/services/codex_remote_policy.rs` | 49 |  |
| `services::codex_tmux_wrapper` | `src/services/codex_tmux_wrapper.rs` | 1506 | giant-file |
...
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 4012 | giant-file |
| `services::codex_tui::session` | `src/services/codex_tui/session.rs` | 496 |  |
| `services::discord` | `src/services/discord/mod.rs` | 7018 | giant-file |
| `services::discord::adk_session` | `src/services/discord/adk_session.rs` | 952 |  |
| `services::discord::agent_handoff` | `src/services/discord/agent_handoff.rs` | 413 |  |
| `services::discord::agentdesk_config` | `src/services/discord/agentdesk_config.rs` | 1456 | giant-file |
| `services::discord::commands` | `src/services/discord/commands/mod.rs` | 110 |  |
| `services::discord::commands::command_policy` | `src/services/discord/commands/command_policy.rs` | 577 |  |
| `services::discord::commands::config` | `src/services/discord/commands/config.rs` | 1900 | giant-file |
| `services::discord::commands::control` | `src/services/discord/commands/control.rs` | 924 |  |
| `services::discord::commands::diagnostics` | `src/services/discord/commands/diagnostics.rs` | 1138 | giant-file |
...
| `services::discord::commands::help` | `src/services/discord/commands/help.rs` | 132 |  |
...
| `services::discord::commands::receipt` | `src/services/discord/commands/receipt.rs` | 396 |  |
...
| `services::discord::commands::skill` | `src/services/discord/commands/skill.rs` | 418 |  |
| `services::discord::commands::text_commands` | `src/services/discord/commands/text_commands.rs` | 1493 | giant-file |
| `services::discord::commands::tui_passthrough` | `src/services/discord/commands/tui_passthrough.rs` | 313 |  |
| `services::discord::commands::voice` | `src/services/discord/commands/voice.rs` | 1003 | giant-file |
| `services::discord::discord_io` | `src/services/discord/discord_io.rs` | 612 |  |
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 4437 | giant-file |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 1027 | giant-file |
| `services::discord::health` | `src/services/discord/health.rs` | 6308 | giant-file |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 3156 | giant-file |
...
| `services::discord::http` | `src/services/discord/http.rs` | 178 |  |
| `services::discord::idle_detector` | `src/services/discord/idle_detector.rs` | 712 |  |
| `services::discord::idle_recap` | `src/services/discord/idle_recap.rs` | 1144 | giant-file |
| `services::discord::idle_recap_interaction` | `src/services/discord/idle_recap_interaction.rs` | 192 |  |
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 3561 | giant-file |
| `services::discord::inflight_heartbeat_sweeper` | `src/services/discord/inflight_heartbeat_sweeper.rs` | 292 |  |
| `services::discord::internal_api` | `src/services/discord/internal_api.rs` | 843 |  |
...
| `services::discord::metrics` | `src/services/discord/metrics.rs` | 153 |  |
...
| `services::discord::outbound::confirmation` | `src/services/discord/outbound/confirmation.rs` | 61 |  |
...
| `services::discord::placeholder_live_events` | `src/services/discord/placeholder_live_events/mod.rs` | 319 |  |
| `services::discord::placeholder_live_events::common` | `src/services/discord/placeholder_live_events/common.rs` | 144 |  |
| `services::discord::placeholder_live_events::context_panel` | `src/services/discord/placeholder_live_events/context_panel.rs` | 59 |  |
| `services::discord::placeholder_live_events::recent_events` | `src/services/discord/placeholder_live_events/recent_events.rs` | 239 |  |
| `services::discord::placeholder_live_events::session_panel` | `src/services/discord/placeholder_live_events/session_panel.rs` | 204 |  |
| `services::discord::placeholder_live_events::status_events` | `src/services/discord/placeholder_live_events/status_events.rs` | 401 |  |
| `services::discord::placeholder_live_events::status_panel` | `src/services/discord/placeholder_live_events/status_panel.rs` | 543 |  |
| `services::discord::placeholder_live_events::task_panel` | `src/services/discord/placeholder_live_events/task_panel.rs` | 125 |  |
| `services::discord::placeholder_live_events::workflow_panel` | `src/services/discord/placeholder_live_events/workflow_panel.rs` | 185 |  |
| `services::discord::placeholder_sweeper` | `src/services/discord/placeholder_sweeper.rs` | 1173 | giant-file |
...
| `services::discord::queue_io` | `src/services/discord/queue_io.rs` | 706 |  |
| `services::discord::queued_placeholders_store` | `src/services/discord/queued_placeholders_store.rs` | 412 |  |
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 5954 | giant-file |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 953 |  |
...
| `services::discord::role_map` | `src/services/discord/role_map.rs` | 912 |  |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 3125 | giant-file |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 89 |  |
| `services::discord::router::message_handler::attachments` | `src/services/discord/router/message_handler/attachments.rs` | 142 |  |
| `services::discord::router::message_handler::control` | `src/services/discord/router/message_handler/control.rs` | 173 |  |
| `services::discord::router::message_handler::goal_lifecycle` | `src/services/discord/router/message_handler/goal_lifecycle.rs` | 255 |  |
| `services::discord::router::message_handler::headless_turn` | `src/services/discord/router/message_handler/headless_turn.rs` | 1318 | giant-file |
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 3898 | giant-file |
| `services::discord::router::message_handler::provider_isolation` | `src/services/discord/router/message_handler/provider_isolation.rs` | 504 |  |
| `services::discord::router::message_handler::tui_followup` | `src/services/discord/router/message_handler/tui_followup.rs` | 467 |  |
| `services::discord::router::message_handler::turn_lifecycle` | `src/services/discord/router/message_handler/turn_lifecycle.rs` | 183 |  |
| `services::discord::router::message_handler::watchdog` | `src/services/discord/router/message_handler/watchdog.rs` | 858 |  |
| `services::discord::router::response_format` | `src/services/discord/router/response_format.rs` | 357 |  |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 3650 | giant-file |
| `services::discord::runtime_store` | `src/services/discord/runtime_store.rs` | 497 |  |
| `services::discord::session_identity` | `src/services/discord/session_identity.rs` | 185 |  |
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 1494 | giant-file |
...
| `services::discord::stall_recovery` | `src/services/discord/stall_recovery.rs` | 113 |  |
| `services::discord::standby_relay` | `src/services/discord/standby_relay.rs` | 1136 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 6746 | giant-file |
| `services::discord::tmux_error_detect` | `src/services/discord/tmux_error_detect.rs` | 333 |  |
| `services::discord::tmux_kill_policy` | `src/services/discord/tmux_kill_policy.rs` | 802 |  |
...
| `services::discord::tmux_restart_handoff` | `src/services/discord/tmux_restart_handoff.rs` | 728 |  |
| `services::discord::tmux_session_files` | `src/services/discord/tmux_session_files.rs` | 329 |  |
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 7223 | giant-file |
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 4487 | giant-file |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 9564 | giant-file |
| `services::discord::turn_bridge::completion_guard` | `src/services/discord/turn_bridge/completion_guard.rs` | 2540 | giant-file |
| `services::discord::turn_bridge::context_window` | `src/services/discord/turn_bridge/context_window.rs` | 119 |  |
...
| `services::discord::turn_bridge::recall_feedback` | `src/services/discord/turn_bridge/recall_feedback.rs` | 818 |  |
...
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 606 |  |
| `services::discord::turn_bridge::tmux_runtime` | `src/services/discord/turn_bridge/tmux_runtime.rs` | 1670 | giant-file |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 6381 | giant-file |
| `services::discord::voice_routing` | `src/services/discord/voice_routing.rs` | 160 |  |
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 2793 | giant-file |
| `services::discord::watchers::lifecycle_decision` | `src/services/discord/watchers/lifecycle_decision.rs` | 254 |  |
| `services::discord_config_audit` | `src/services/discord_config_audit.rs` | 1787 | giant-file |
...
| `services::dispatched_sessions` | `src/services/dispatched_sessions.rs` | 3423 | giant-file |
| `services::dispatches` | `src/services/dispatches/mod.rs` | 563 |  |
...
| `services::dispatches::discord_delivery::transport` | `src/services/dispatches/discord_delivery/transport.rs` | 906 |  |
...
| `services::dispatches::outbox_route` | `src/services/dispatches/outbox_route.rs` | 1158 | giant-file |
...
| `services::gemini` | `src/services/gemini.rs` | 2598 | giant-file |
...
| `services::issue_announcements` | `src/services/issue_announcements.rs` | 578 |  |
...
| `services::memory::memento` | `src/services/memory/memento.rs` | 3358 | giant-file |
...
| `services::message_outbox` | `src/services/message_outbox.rs` | 1137 | giant-file |
| `services::observability` | `src/services/observability/mod.rs` | 1150 | giant-file |
| `services::observability::emit` | `src/services/observability/emit.rs` | 770 |  |
...
| `services::observability::metrics` | `src/services/observability/metrics.rs` | 490 |  |
...
| `services::observability::session_inventory` | `src/services/observability/session_inventory.rs` | 355 |  |
...
| `services::onboarding` | `src/services/onboarding/mod.rs` | 5026 | giant-file |
| `services::onboarding::channel` | `src/services/onboarding/channel.rs` | 214 |  |
| `services::onboarding::provider` | `src/services/onboarding/provider.rs` | 172 |  |
| `services::opencode` | `src/services/opencode.rs` | 2726 | giant-file |
| `services::operator_connectors` | `src/services/operator_connectors.rs` | 477 |  |
| `services::pipeline_override` | `src/services/pipeline_override.rs` | 1001 | giant-file |
| `services::pipeline_routes` | `src/services/pipeline_routes.rs` | 644 |  |
| `services::platform` | `src/services/platform/mod.rs` | 25 |  |
| `services::platform::binary_resolver` | `src/services/platform/binary_resolver.rs` | 1936 | giant-file |
...
| `services::platform::tmux` | `src/services/platform/tmux.rs` | 1085 | giant-file |
| `services::pr_summary` | `src/services/pr_summary.rs` | 542 |  |
| `services::process` | `src/services/process.rs` | 1490 | giant-file |
| `services::provider` | `src/services/provider.rs` | 3735 | giant-file |
| `services::provider_auth` | `src/services/provider_auth.rs` | 322 |  |
...
| `services::provider_cli::snapshot` | `src/services/provider_cli/snapshot.rs` | 253 |  |
...
| `services::provider_hosting` | `src/services/provider_hosting.rs` | 1071 | giant-file |
| `services::provider_runtime` | `src/services/provider_runtime.rs` | 122 |  |
| `services::queue` | `src/services/queue.rs` | 908 |  |
| `services::qwen` | `src/services/qwen.rs` | 2760 | giant-file |
| `services::qwen_tmux_wrapper` | `src/services/qwen_tmux_wrapper.rs` | 1287 | giant-file |
| `services::remote_stub` | `src/services/remote_stub.rs` | 45 |  |
| `services::retrospectives` | `src/services/retrospectives.rs` | 882 |  |
| `services::routines` | `src/services/routines/mod.rs` | 32 |  |
| `services::routines::action` | `src/services/routines/action.rs` | 330 |  |
| `services::routines::agent_executor` | `src/services/routines/agent_executor.rs` | 1313 | giant-file |
| `services::routines::discord_log` | `src/services/routines/discord_log.rs` | 1679 | giant-file |
| `services::routines::loader` | `src/services/routines/loader.rs` | 2318 | giant-file |
| `services::routines::migrated` | `src/services/routines/migrated.rs` | 1286 | giant-file |
| `services::routines::runtime` | `src/services/routines/runtime.rs` | 914 |  |
| `services::routines::runtime_config` | `src/services/routines/runtime_config.rs` | 108 |  |
| `services::routines::session_control` | `src/services/routines/session_control.rs` | 714 |  |
| `services::routines::store` | `src/services/routines/store.rs` | 3240 | giant-file |
| `services::service_error` | `src/services/service_error.rs` | 1 |  |
| `services::session_backend` | `src/services/session_backend.rs` | 1391 | giant-file |
| `services::session_forwarding` | `src/services/session_forwarding.rs` | 490 |  |
...
| `services::tmux_common` | `src/services/tmux_common.rs` | 1328 | giant-file |
| `services::tmux_diagnostics` | `src/services/tmux_diagnostics.rs` | 385 |  |
| `services::tmux_wrapper` | `src/services/tmux_wrapper.rs` | 728 |  |
| `services::tool_output_guard` | `src/services/tool_output_guard.rs` | 237 |  |
| `services::tui_prompt_dedupe` | `src/services/tui_prompt_dedupe.rs` | 1875 | giant-file |
| `services::tui_turn_state` | `src/services/tui_turn_state.rs` | 1105 | giant-file |
| `services::turn_cancel_finalizer` | `src/services/turn_cancel_finalizer.rs` | 479 |  |
| `services::turn_lifecycle` | `src/services/turn_lifecycle.rs` | 770 |  |
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 4679 | giant-file |
| `supervisor` | `src/supervisor/mod.rs` | 746 |  |
| `ui` | `src/ui/mod.rs` | 1 |  |
| `ui::ai_screen` | `src/ui/ai_screen.rs` | 155 |  |
| `utils` | `src/utils/mod.rs` | 10 |  |
| `utils::api` | `src/utils/api.rs` | 55 |  |
| `utils::async_bridge` | `src/utils/async_bridge.rs` | 288 |  |
...
| `utils::redact` | `src/utils/redact.rs` | 168 |  |
| `utils::secret_file` | `src/utils/secret_file.rs` | 208 |  |
