...
| `config` | `src/config.rs` | 1636 | giant-file |
...
| `engine::ops::review_automation_ops` | `src/engine/ops/review_automation_ops.rs` | 503 |  |
...
| `server` | `src/server/mod.rs` | 2208 | giant-file |
...
| `server::routes::analytics` | `src/server/routes/analytics.rs` | 1026 | giant-file |
...
| `services::discord::commands` | `src/services/discord/commands/mod.rs` | 43 |  |
| `services::discord::commands::config` | `src/services/discord/commands/config.rs` | 1224 | giant-file |
| `services::discord::commands::control` | `src/services/discord/commands/control.rs` | 530 |  |
| `services::discord::commands::diagnostics` | `src/services/discord/commands/diagnostics.rs` | 1037 | giant-file |
| `services::discord::commands::fast_mode` | `src/services/discord/commands/fast_mode.rs` | 113 |  |
| `services::discord::commands::help` | `src/services/discord/commands/help.rs` | 67 |  |
...
| `services::discord::health` | `src/services/discord/health.rs` | 1962 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 1977 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 3468 | giant-file |
| `services::discord::router::thread_binding` | `src/services/discord/router/thread_binding.rs` | 129 |  |
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 1373 | giant-file |
...
| `services::discord::settings` | `src/services/discord/settings.rs` | 2557 | giant-file |
...
| `services::discord::settings::read` | `src/services/discord/settings/read.rs` | 366 |  |
| `services::discord::settings::validation` | `src/services/discord/settings/validation.rs` | 213 |  |
| `services::discord::settings::write` | `src/services/discord/settings/write.rs` | 333 |  |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 2101 | giant-file |
...
| `services::gemini` | `src/services/gemini.rs` | 2545 | giant-file |
| `services::kanban` | `src/services/kanban.rs` | 145 |  |
| `services::mcp_config` | `src/services/mcp_config.rs` | 633 |  |
