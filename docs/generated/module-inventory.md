...
| `server::routes` | `src/server/routes/mod.rs` | 274 |  |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 3972 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 203 |  |
...
| `services::discord::health` | `src/services/discord/health.rs` | 5758 | giant-file |
