...
| `cli::direct` | `src/cli/direct.rs` | 1809 | 1809 | 0 | giant-file |
...
| `db::dispatched_sessions` | `src/db/dispatched_sessions.rs` | 2125 | 1628 | 497 | giant-file |
...
| `dispatch::dispatch_context` | `src/dispatch/dispatch_context.rs` | 3936 | 2803 | 1133 | giant-file |
| `dispatch::dispatch_create` | `src/dispatch/dispatch_create.rs` | 1509 | 1379 | 130 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 6677 | 6196 | 481 | giant-file |
...
| `server::routes::github` | `src/server/routes/github.rs` | 926 | 801 | 125 |  |
| `server::routes::github_dashboard` | `src/server/routes/github_dashboard.rs` | 188 | 188 | 0 |  |
| `server::routes::health_api` | `src/server/routes/health_api.rs` | 2531 | 2056 | 475 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 755 | 602 | 153 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 7322 | 3003 | 4319 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4189 | 3437 | 752 | giant-file |
...
| `services::discord::relay_recovery` | `src/services/discord/relay_recovery.rs` | 1896 | 1006 | 890 | giant-file |
...
| `services::discord::session_runtime` | `src/services/discord/session_runtime.rs` | 2168 | 1679 | 489 | giant-file |
...
| `services::discord::single_message_panel` | `src/services/discord/single_message_panel.rs` | 2617 | 715 | 1902 |  |
...
| `services::discord::tmux_watcher::single_message_footer` | `src/services/discord/tmux_watcher/single_message_footer.rs` | 633 | 502 | 131 |  |
...
| `services::discord::tui_prompt_relay::injected_prompt_policy` | `src/services/discord/tui_prompt_relay/injected_prompt_policy.rs` | 486 | 486 | 0 |  |
...
| `services::discord::turn_bridge::single_message_footer` | `src/services/discord/turn_bridge/single_message_footer.rs` | 508 | 419 | 89 |  |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 3047 | 2324 | 723 | giant-file |
...
| `services::dispatched_sessions` | `src/services/dispatched_sessions.rs` | 1730 | 1546 | 184 | giant-file |
