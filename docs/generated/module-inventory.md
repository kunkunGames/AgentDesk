...
| `services::discord::commands::fast_mode` | `src/services/discord/commands/fast_mode.rs` | 146 |  |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 1347 | giant-file |
...
| `services::discord::settings` | `src/services/discord/settings.rs` | 2451 | giant-file |
