...
| `cli::args` | `src/cli/args.rs` | 1166 | giant-file |
...
| `cli::doctor::orchestrator` | `src/cli/doctor/orchestrator.rs` | 5360 | giant-file |
...
| `engine::ops::db_ops` | `src/engine/ops/db_ops.rs` | 1672 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 6235 | giant-file |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 1115 | giant-file |
...
| `services::claude` | `src/services/claude.rs` | 4981 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 11413 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 8430 | giant-file |
...
| `services::mcp_config` | `src/services/mcp_config.rs` | 1664 | giant-file |
...
| `services::provider` | `src/services/provider.rs` | 3613 | giant-file |
...
| `services::routines::loader` | `src/services/routines/loader.rs` | 2214 | giant-file |
| `services::routines::migrated` | `src/services/routines/migrated.rs` | 717 |  |
...
| `services::tui_turn_state` | `src/services/tui_turn_state.rs` | 971 |  |
