...
| `server::routes::idle_recap` | `src/server/routes/idle_recap.rs` | 76 |  |
...
| `services::discord::placeholder_controller` | `src/services/discord/placeholder_controller.rs` | 1260 | giant-file |
...
| `services::opencode` | `src/services/opencode.rs` | 2609 | giant-file |
...
| `voice::utils` | `src/voice/utils.rs` | 63 |  |
