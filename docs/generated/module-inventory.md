...
| `cli::provider_cli` | `src/cli/provider_cli/mod.rs` | 767 |  |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 3665 | giant-file |
...
| `server::routes::provider_cli_api` | `src/server/routes/provider_cli_api.rs` | 266 |  |
