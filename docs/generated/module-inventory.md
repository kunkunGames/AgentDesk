...
| `cli::args` | `src/cli/args.rs` | 1020 | giant-file |
...
| `dispatch::dispatch_context` | `src/dispatch/dispatch_context.rs` | 4459 | giant-file |
...
| `server` | `src/server/mod.rs` | 3864 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 6174 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 332 |  |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 998 |  |
| `server::ws` | `src/server/ws.rs` | 277 |  |
| `services` | `src/services/mod.rs` | 74 |  |
...
| `services::claude` | `src/services/claude.rs` | 3719 | giant-file |
| `services::claude_tui` | `src/services/claude_tui/mod.rs` | 6 |  |
| `services::claude_tui::hook_bundle` | `src/services/claude_tui/hook_bundle.rs` | 351 |  |
...
| `services::codex` | `src/services/codex.rs` | 2601 | giant-file |
| `services::codex_tmux_wrapper` | `src/services/codex_tmux_wrapper.rs` | 717 |  |
| `services::codex_tui` | `src/services/codex_tui/mod.rs` | 2 |  |
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 1228 | giant-file |
| `services::codex_tui::session` | `src/services/codex_tui/session.rs` | 326 |  |
| `services::discord` | `src/services/discord/mod.rs` | 6376 | giant-file |
...
| `services::discord::commands::diagnostics` | `src/services/discord/commands/diagnostics.rs` | 1063 | giant-file |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 1448 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 5216 | giant-file |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 2585 | giant-file |
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 8413 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 5082 | giant-file |
| `services::discord::turn_bridge::completion_guard` | `src/services/discord/turn_bridge/completion_guard.rs` | 2457 | giant-file |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 3277 | giant-file |
...
| `services::provider_hosting` | `src/services/provider_hosting.rs` | 256 |  |
...
| `voice::announce_meta` | `src/voice/announce_meta.rs` | 107 |  |
...
| `voice::prompt` | `src/voice/prompt.rs` | 626 |  |
