...
| `cli::doctor::orchestrator` | `src/cli/doctor/orchestrator.rs` | 4493 | 4376 | 117 | giant-file |
...
| `config` | `src/config.rs` | 2446 | 2320 | 126 | giant-file |
...
| `server` | `src/server/mod.rs` | 2821 | 2430 | 391 | giant-file |
...
| `server::routes::agents` | `src/server/routes/agents.rs` | 1059 | 1059 | 0 | giant-file |
...
| `services::auto_queue::query` | `src/services/auto_queue/query.rs` | 267 | 247 | 20 |  |
...
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 2651 | 1540 | 1111 | giant-file |
...
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 4653 | 1776 | 2877 | giant-file |
| `services::codex_tui::session` | `src/services/codex_tui/session.rs` | 496 | 279 | 217 |  |
| `services::discord` | `src/services/discord/mod.rs` | 5803 | 4981 | 822 | giant-file |
...
| `services::discord::health::headless_turn` | `src/services/discord/health/headless_turn.rs` | 352 | 352 | 0 |  |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 5383 | 2523 | 2860 | giant-file |
...
| `services::discord::outbound::turn_output_controller` | `src/services/discord/outbound/turn_output_controller.rs` | 2970 | 995 | 1975 |  |
...
| `services::discord::router::message_handler::headless_turn` | `src/services/discord/router/message_handler/headless_turn.rs` | 1359 | 1359 | 0 | giant-file |
| `services::discord::router::message_handler::headless_turn_routine` | `src/services/discord/router/message_handler/headless_turn_routine.rs` | 146 | 146 | 0 |  |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 4171 | 1731 | 2440 | giant-file |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 12123 | 8223 | 3900 | giant-file |
...
| `services::discord::tmux_watcher::terminal_send` | `src/services/discord/tmux_watcher/terminal_send.rs` | 584 | 584 | 0 |  |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 7953 | 6811 | 1142 | giant-file |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 4566 | 2813 | 1753 | giant-file |
...
| `services::routines::agent_executor` | `src/services/routines/agent_executor.rs` | 2381 | 1943 | 438 | giant-file |
...
| `services::tmux_common` | `src/services/tmux_common.rs` | 1430 | 873 | 557 |  |
...
| `utils::redact` | `src/utils/redact.rs` | 214 | 122 | 92 |  |
