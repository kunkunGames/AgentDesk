...
| `services::claude` | `src/services/claude.rs` | 4915 | 3938 | 977 | giant-file |
...
| `services::claude_tui::hook_bundle` | `src/services/claude_tui/hook_bundle.rs` | 1214 | 733 | 481 |  |
| `services::claude_tui::hook_relay` | `src/services/claude_tui/hook_relay.rs` | 704 | 416 | 288 |  |
| `services::claude_tui::hook_server` | `src/services/claude_tui/hook_server.rs` | 904 | 466 | 438 |  |
| `services::claude_tui::input` | `src/services/claude_tui/input.rs` | 2245 | 1294 | 951 | giant-file |
...
| `services::codex_tmux_wrapper` | `src/services/codex_tmux_wrapper.rs` | 1956 | 1215 | 741 | giant-file |
...
| `services::codex_tui::rollout_tail` | `src/services/codex_tui/rollout_tail.rs` | 3921 | 1639 | 2282 | giant-file |
| `services::codex_tui::session` | `src/services/codex_tui/session.rs` | 496 | 279 | 217 |  |
| `services::discord` | `src/services/discord/mod.rs` | 5717 | 5175 | 542 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 2944 | 2240 | 704 | giant-file |
...
| `services::discord::health::recovery` | `src/services/discord/health/recovery.rs` | 3720 | 2645 | 1075 | giant-file |
...
| `services::discord::idle_recap` | `src/services/discord/idle_recap.rs` | 2304 | 1320 | 984 | giant-file |
| `services::discord::idle_recap_interaction` | `src/services/discord/idle_recap_interaction.rs` | 192 | 192 | 0 |  |
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 4792 | 2454 | 2338 | giant-file |
...
| `services::discord::queue_io` | `src/services/discord/queue_io.rs` | 190 | 163 | 27 |  |
...
| `services::discord::router::intake_gate` | `src/services/discord/router/intake_gate.rs` | 3471 | 2967 | 504 | giant-file |
...
| `services::discord::router::message_handler::intake_turn` | `src/services/discord/router/message_handler/intake_turn.rs` | 4103 | 3808 | 295 | giant-file |
...
| `services::discord::router::message_handler::tui_followup` | `src/services/discord/router/message_handler/tui_followup.rs` | 678 | 678 | 0 |  |
...
| `services::discord::runtime_store` | `src/services/discord/runtime_store.rs` | 301 | 273 | 28 |  |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 14450 | 9581 | 4869 | giant-file |
| `services::discord::tui_direct_pending_start` | `src/services/discord/tui_direct_pending_start.rs` | 1114 | 533 | 581 |  |
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 8570 | 5438 | 3132 | giant-file |
| `services::discord::tui_task_card` | `src/services/discord/tui_task_card.rs` | 1206 | 739 | 467 |  |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 11037 | 8368 | 2669 | giant-file |
...
| `services::discord::turn_bridge::watcher_handoff` | `src/services/discord/turn_bridge/watcher_handoff.rs` | 294 | 245 | 49 |  |
| `services::discord::turn_finalizer` | `src/services/discord/turn_finalizer.rs` | 5383 | 1528 | 3855 | giant-file |
...
| `services::discord::voice_barge_in` | `src/services/discord/voice_barge_in.rs` | 6389 | 4657 | 1732 | giant-file |
...
| `services::dispatches::outbox_queue` | `src/services/dispatches/outbox_queue.rs` | 388 | 388 | 0 |  |
...
| `services::platform::tmux` | `src/services/platform/tmux.rs` | 1169 | 865 | 304 |  |
| `services::pr_summary` | `src/services/pr_summary.rs` | 542 | 321 | 221 |  |
| `services::process` | `src/services/process.rs` | 1119 | 638 | 481 |  |
| `services::provider` | `src/services/provider.rs` | 2778 | 1796 | 982 | giant-file |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 5121 | 3087 | 2034 | giant-file |
