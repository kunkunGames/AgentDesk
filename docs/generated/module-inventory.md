...
| `cli::doctor::orchestrator` | `src/cli/doctor/orchestrator.rs` | 5284 | giant-file |
| `cli::doctor::startup` | `src/cli/doctor/startup.rs` | 515 |  |
| `cli::init` | `src/cli/init.rs` | 1749 | giant-file |
...
| `config` | `src/config.rs` | 3318 | giant-file |
| `crate` | `src/main.rs` | 7 |  |
...
| `db::postgres` | `src/db/postgres.rs` | 1981 | giant-file |
...
| `server` | `src/server/mod.rs` | 4076 | giant-file |
...
| `services` | `src/services/mod.rs` | 81 |  |
| `services::agent_protocol` | `src/services/agent_protocol.rs` | 384 |  |
...
| `services::claude` | `src/services/claude.rs` | 5196 | giant-file |
...
| `services::claude_e::process` | `src/services/claude_e/process.rs` | 357 |  |
...
| `services::codex` | `src/services/codex.rs` | 3851 | giant-file |
| `services::codex_remote_policy` | `src/services/codex_remote_policy.rs` | 49 |  |
| `services::codex_tmux_wrapper` | `src/services/codex_tmux_wrapper.rs` | 932 |  |
...
| `services::discord` | `src/services/discord/mod.rs` | 6892 | giant-file |
...
| `services::discord::agentdesk_config` | `src/services/discord/agentdesk_config.rs` | 1407 | giant-file |
...
| `services::discord::commands::skill` | `src/services/discord/commands/skill.rs` | 396 |  |
| `services::discord::commands::text_commands` | `src/services/discord/commands/text_commands.rs` | 1464 | giant-file |
...
| `services::discord::formatting` | `src/services/discord/formatting.rs` | 4187 | giant-file |
| `services::discord::gateway` | `src/services/discord/gateway.rs` | 978 |  |
| `services::discord::health` | `src/services/discord/health.rs` | 6008 | giant-file |
...
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 3509 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 5751 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 11597 | giant-file |
...
| `services::discord::runtime_bootstrap` | `src/services/discord/runtime_bootstrap.rs` | 3470 | giant-file |
...
| `services::discord::session_relay_sink` | `src/services/discord/session_relay_sink.rs` | 1125 | giant-file |
...
| `services::discord::tmux` | `src/services/discord/tmux.rs` | 6502 | giant-file |
...
| `services::discord::tmux_watcher` | `src/services/discord/tmux_watcher.rs` | 7002 | giant-file |
| `services::discord::tui_prompt_relay` | `src/services/discord/tui_prompt_relay.rs` | 2616 | giant-file |
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 8584 | giant-file |
...
| `services::discord::turn_bridge::terminal_delivery` | `src/services/discord/turn_bridge/terminal_delivery.rs` | 277 |  |
...
| `services::discord::watchers::lifecycle` | `src/services/discord/watchers/lifecycle.rs` | 2235 | giant-file |
...
| `services::dispatched_sessions` | `src/services/dispatched_sessions.rs` | 3393 | giant-file |
...
| `services::dispatches::discord_delivery::transport` | `src/services/dispatches/discord_delivery/transport.rs` | 887 |  |
...
| `services::observability::emit` | `src/services/observability/emit.rs` | 714 |  |
...
| `services::observability::metrics` | `src/services/observability/metrics.rs` | 483 |  |
...
| `services::onboarding` | `src/services/onboarding/mod.rs` | 4948 | giant-file |
...
| `services::provider` | `src/services/provider.rs` | 3666 | giant-file |
...
| `services::routines::agent_executor` | `src/services/routines/agent_executor.rs` | 786 |  |
| `services::routines::discord_log` | `src/services/routines/discord_log.rs` | 1679 | giant-file |
| `services::routines::loader` | `src/services/routines/loader.rs` | 2248 | giant-file |
...
| `services::routines::store` | `src/services/routines/store.rs` | 3238 | giant-file |
| `services::service_error` | `src/services/service_error.rs` | 1 |  |
| `services::session_backend` | `src/services/session_backend.rs` | 1337 | giant-file |
...
| `services::tui_prompt_dedupe` | `src/services/tui_prompt_dedupe.rs` | 1701 | giant-file |
...
| `services::turn_orchestrator` | `src/services/turn_orchestrator.rs` | 4193 | giant-file |
