...
| `config` | `src/config.rs` | 2409 | giant-file |
...
| `server::routes::docs` | `src/server/routes/docs.rs` | 4242 | giant-file |
...
| `server::routes::domains::ops` | `src/server/routes/domains/ops.rs` | 286 |  |
...
| `server::routes::routines` | `src/server/routes/routines.rs` | 761 |  |
...
| `server::worker_registry` | `src/server/worker_registry.rs` | 640 |  |
...
| `services::discord::commands::command_policy` | `src/services/discord/commands/command_policy.rs` | 520 |  |
...
| `services::discord::commands::text_commands` | `src/services/discord/commands/text_commands.rs` | 1262 | giant-file |
...
| `services::discord::health` | `src/services/discord/health.rs` | 5179 | giant-file |
| `services::discord::idle_detector` | `src/services/discord/idle_detector.rs` | 587 |  |
| `services::discord::inflight` | `src/services/discord/inflight.rs` | 1245 | giant-file |
...
| `services::discord::recovery_engine` | `src/services/discord/recovery_engine.rs` | 4699 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 7304 | giant-file |
...
| `services::discord::turn_bridge` | `src/services/discord/turn_bridge/mod.rs` | 3656 | giant-file |
...
| `services::routines::discord_log` | `src/services/routines/discord_log.rs` | 677 |  |
