...
| `config` | `src/config.rs` | 2227 | giant-file |
| `crate` | `src/main.rs` | 43 |  |
| `credential` | `src/credential.rs` | 24 |  |
| `db` | `src/db/mod.rs` | 248 |  |
| `db::agents` | `src/db/agents.rs` | 1058 | giant-file |
...
| `services::discord` | `src/services/discord/mod.rs` | 3711 | giant-file |
...
| `services::discord::router::message_handler` | `src/services/discord/router/message_handler.rs` | 6018 | giant-file |
