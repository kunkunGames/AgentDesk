...
- Tracked (owner + deadline + decompose issue): `6`
...
| `src/services/discord/turn_bridge/mod.rs` | 6189 | discord-relay | 2026-08-31 | #3038 |
...
| `src/engine/ops/db_ops.rs` | 1134 |
| `src/github/sync.rs` | 1488 |
| `src/pipeline.rs` | 1314 |
| `src/receipt.rs` | 1842 |
| `src/reconcile.rs` | 1816 |
| `src/server/mod.rs` | 2453 |
| `src/server/routes/agents.rs` | 1106 |
...
| `src/server/routes/health_api.rs` | 2000 |
...
| `src/services/auto_queue/activate_command.rs` | 1456 |
| `src/services/auto_queue/cancel_run.rs` | 1032 |
| `src/services/claude.rs` | 2963 |
| `src/services/claude_tui/input.rs` | 1629 |
