...
- Grandfathered (awaiting owner/deadline backfill or decomposition): `85`
...
| `src/services/discord/idle_recap.rs` | 1320 | discord-recap | 2026-08-31 | #3036 |
| `src/services/discord/session_relay_sink.rs` | 1731 | discord-relay | 2026-08-31 | #3036 |
| `src/services/discord/turn_bridge/mod.rs` | 8368 | discord-relay | 2026-08-31 | #3016 |
...
| `src/services/claude.rs` | 3938 |
| `src/services/claude_tui/input.rs` | 1294 |
| `src/services/codex.rs` | 3001 |
| `src/services/codex_tmux_wrapper.rs` | 1215 |
| `src/services/codex_tui/input.rs` | 1350 |
| `src/services/codex_tui/rollout_tail.rs` | 1639 |
...
| `src/services/discord/health.rs` | 2240 |
| `src/services/discord/health/recovery.rs` | 2645 |
| `src/services/discord/inflight.rs` | 2454 |
| `src/services/discord/meeting_orchestrator.rs` | 3222 |
| `src/services/discord/mod.rs` | 5175 |
| `src/services/discord/recovery_engine.rs` | 4090 |
| `src/services/discord/router/intake_gate.rs` | 2967 |
| `src/services/discord/router/message_handler/headless_turn.rs` | 1316 |
| `src/services/discord/router/message_handler/intake_turn.rs` | 3808 |
...
| `src/services/discord/tmux_watcher.rs` | 9581 |
