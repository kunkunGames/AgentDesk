...
|---|---|---:|---|
| warn | `src/services/discord/inflight.rs` |  | 5243 test LoC vs 642 prod LoC (ratio 8.17x > 3x, 5885 raw); migrate the stranded tests with the decomposed production code |
...
| warn | `src/services/discord/turn_finalizer.rs` |  | 3992 test LoC vs 1029 prod LoC (ratio 3.88x > 3x, 5021 raw); migrate the stranded tests with the decomposed production code |
