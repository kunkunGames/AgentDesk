...
|---|---|---:|---|
| warn | `src/services/discord/inflight.rs` |  | 5209 test LoC vs 608 prod LoC (ratio 8.57x > 3x, 5817 raw); migrate the stranded tests with the decomposed production code |
