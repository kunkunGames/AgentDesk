...
|---|---|---:|---|
| warn | `src/services/discord/inflight.rs` |  | 5386 test LoC vs 674 prod LoC (ratio 7.99x > 3x, 6060 raw); migrate the stranded tests with the decomposed production code |
...
| info | `src/db/intake_outbox.rs` | 834 | duplicated clamp `limit::1`: `limit.max(1)` |
