...
- do_not_edit_without_migration_plan (giant-file routes):
  ...
  - `src/server/routes/docs.rs` (5900 lines; +16 from fixing decomposition regressions during hygiene improvements).
...
- `src/services/claude_tui/input.rs` (1390) — Claude TUI input readiness
