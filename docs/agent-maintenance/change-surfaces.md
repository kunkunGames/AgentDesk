...
- do_not_edit_without_migration_plan:
  ...
  - `src/engine/ops/db_ops.rs` (1218 lines, giant-file).
...
- do_not_edit_without_migration_plan (giant-file, awaiting split issue):
  ...
  - `src/dispatch/dispatch_status.rs` (1511 lines).
...
- do_not_edit_without_migration_plan (giant-file):
  - `src/services/discord/watchers/lifecycle.rs` (2338 lines — canonical
    lifecycle extraction surface from #1435; split further before adding new
    lifecycle behavior).
  - `src/services/discord/tmux.rs` (2252 lines after #2558 dead-code sweep;
...
- `src/db/automation_candidates.rs` (1003 lines, giant-file).
- `src/voice/announce_meta.rs` (1001 lines, giant-file).
