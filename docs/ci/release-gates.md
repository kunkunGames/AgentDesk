...
| **Watcher reattach** | tmux 출력 watcher / deadlock watchdog 가 재시작 후 정상 재부착되고 stale 입력에 잘못 알림 보내지 않도록 | `high_risk_recovery::delayed_runner::scenario_421_deadlock_recent_output_extends_watchdog`, `delayed_runner::scenario_421_deadlock_stale_output_only_marks_suspected_deadlock`, `delayed_runner::scenario_421_long_turn_alerts_start_at_30_minutes` |
