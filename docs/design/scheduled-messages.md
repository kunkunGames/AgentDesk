...
`migrations/postgres/0079_scheduled_messages.sql` (0074~0078은 upstream이 선점).
...
| 파일 | 내용 |
|---|---|
| `migrations/postgres/0079_scheduled_messages.sql` | 위 스키마 (+ immutable-checksums.json 갱신) |
